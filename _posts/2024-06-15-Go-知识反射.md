...
#### Go-知识反射
  ...
  * [1\. 接口](<#1__2>)
  *     * [1.1 类型](<#11__3>)
    * [1.2 interface 类型](<#12_interface__16>)
    *       * [1.2.1 interface 变量](<#121_interface__24>)
      * [1.2.2 实现接口](<#122__32>)
      * [1.2.3 复合类型](<#123__62>)
      * [1.2.4 空 interface](<#124__interface_69>)
  * [2\. 反射定律](<#2__74>)
  *     * [2.1 reflect 包](<#21_reflect__77>)
    * [2.2 反射可以将 interface 类型变量转换为反射对象](<#22__interface__88>)
    * [2.3 反射可以将反射对象还原成 interface 对象](<#23__interface__105>)
    * [2.4 反射对象可修改，value 值必须是可设置的](<#24_value__121>)
  * [3\. 思考 接口实现和接口继承](<#3___153>)
