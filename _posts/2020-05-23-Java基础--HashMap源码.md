...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/282e9ea4bcc69b8b8dc6e5b4da8da711.png)  
这是使用idea的功能，查看类的关系。  
可以看到HashMap继承了AbstractMap，实现了Map接口，Cloneable接口和Serializable接口。  
但是，这个结构依然有些粗糙。  
HashMap的结构，可以说一点都不简单。  
HashMap的类图可以如下：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/752893197a4cd30f59eb84ed4ddd9d63.png)  
这什么玩意？  
不要着急，慢慢来。

## 1 HashMap实现的接口

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/47fb39f5ec95acd526d377987dd3509b.png)  
可以看到，HashMap的结构主要是：继承AbstractMap实现Map接口。  
其他的Serializable和Cloneable主要是标记性接口，没有方法定义。  
Map主要定义了作为Map的操作：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/a82f1b10a2084484c588151f68a3961d.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/1dd6adb514ed86e76eed86157375fe4b.png)  
...
其具体的结构图如下：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/0ec90db87145771cca5d4f0b4389fdf5.png)  
而这些类是定义在HashMap类下的，所以姑且我们称这些类内实现的类为组合类。  
即，在HashMap内存在三个组合类：EntrySet，KetSet和Values.  
这些组合类的结构如下：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/eca2e2d00dbd8855df4613bf1896462f.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/1454a62d4d207a6a967b8491f5549887.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/5ab346278857748472513bfaacc31960.png)

从这三个组合类的结构，可以分析出：key，entry不允许重复，而value允许重复。 

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/80f971ce8a7b91d004aa8d031c2ff47e.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/5927bf04ef138fbb32884e87326fbbe9.png)  
...
② 是否存在下一个迭代对象  
③ 获取并偏移迭代指针  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/263b9215c3304968b7fb8d6b856bcccf.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/eb40f942a0f55958c43162f2f854f832.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/99a160868705bf55a7930158c6f44d8c.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/92d2cee1e1a0edecfeb092a1e82ec565.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/e4f0d2c612866d78050e11b3bfad0776.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/f19eaef3ee4e42976cd6b1cca4c5ace6.png)  
Spliterator我将其理解为分割迭代器。  
这个方法我们几乎不会用到，所以，我不会深入讨论这个方法的实现。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/49afd68e7e2c31fcb9d24da5fda2147c.png)  
在Iterable中的方法是这样实现的，通过简单查看其注释，大概是一个迭代其实现的方法，通过快速失败进行迭代。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/50dfffa1a904727e35f289d575323e87.png)  
在HashMap中存在4个Spliterator，后面会详细说明这些的操作。

### 3.2 Collection

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/9a972354c3bf639a228677a180749e37.png)  
Collection和Iteraotor的关系是这样的：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/c32cb3a272da8113758ce2e965a47057.png)  
Collection定义了集合数据结构的通用操作，比如描述集合的size，是否为空；以及集合查询的是否包含；流相关的操作，流化，并行流化；集合操作，增加，删除，清空，更新等操作。

### 3.3 AbstractCollection

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/fa2916ededc8f13d499be81d5df0cddc.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/7491a5ffc82922658b4ffbe05e39f678.png)  
通过查看各个迭代器的继承关系，一个重要的区别是valueSet没有实现Set的接口，也没有继承AbstrctSet抽象类。  
这小节主要是阅读Set接口。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/991b39ea6c37e0f9b42149cd8716efb2.png)  
这是Set的继承关系图。  
看下Set主要定义了些什么操作：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/c4a54b7b9f0904735157dfc3ab3abc37.png)  
可以很清楚的看出，Set并没有增加自己独特的接口方法，都是实现器继承类的方法：Collection和Iterable.  
那么，Set不可重复，是谁来保证呢？我们继续往下看。

### 3.5 AbstractSet

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/decdf702fda013065afb1281dd322b93.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/e1f984e7d29dbc3dc95e8ea7a8d1a5d4.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/a5244d829c368b6a5e915c4c9ef0a663.png)  
通过查看其代码实现，keySet更像是一个代理或者说访问者，我们通过ketSet方法，获得了一个set，然后使用增强for循环的语法糖，进行遍历HashMap的key.  
而增强for循环用到的迭代器是HashMap中的keyIterator。

### 3.7 ValueSet > HashMap

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/f29b5372c013534fd8ad877a90692ecb.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/c26ff8d6f294e37e80d1fa8aed1b95bf.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/eafb5079717aa6dc160c2b841fd85014.png)  
在HashMap中实现了4个迭代器，其中一个是抽象的迭代器HashIterator,其余的迭代器都是继承了这个抽象的迭代器。

### 4.1 HashIterator

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/108e3be8e30ba42779b05f1da62568b7.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/d7b8c6a362269e37f9dc9a0ad936d0cf.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/dcb0b8ce34fb99ae4f2ac9841fb26298.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/92e2ffec4cde9154891467c2a1a2acbe.png)  
那么，这个Node是什么？  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/2b126a77bcd9aa54e4508b21ede7e001.png)

### 5.1 Node(链表)

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/386ae8308e08d0fa465fe80914c68c7d.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/0ed1c7fd61d3594dc65fe0c902e118f4.png)  
众所周知，HashMap在存储的时候，有两种存储状态：链表，红黑树。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/400b126041e97487c1c15b0969ceb1bc.png)  
链表实现继承了Map.Entry接口。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/63e55fdf4335c7bb70f0a64fd5cdaa7f.png)  
链表的节点实现重写了hashCode，对key和value进行hash异或。

### 5.2 TreeNode

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/4c8fd84454e599c531761a15aecf74e5.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/a0f3d5b49acf5c9368fd8fcd133050dc.png)  
...
我们以KeySpliterator为例  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/27a5541989f63b2b0c5a4f009f622229.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/29e5f557d26444dad83399741ff6dce7.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/44eb1c15c290ab706809c73442d6a1df.png)  
在流的操作的时候，我们可能对元素比较多的HashMap或者数据结构，进行多线程处理。但是多线程处理存在并发问题，此时，就需要对数据结构中的元素进行分割，类似于数据分片，一个线程处理一片数据，这样避免并发问题。  
这就是分割迭代器存在的意义。

### 6.2 Spliterator属性

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/e28db2c75715433018048ce692459866.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/6fc6f96cefee62f4c6f54773947f085e.png)  
getFence初始化分割迭代器  
estimateSize初始化并获取分割迭代器的大小

### 6.4 KeySpliterator,ValueSpliterator,EntrySpliterator

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/c61f222d321ad4bc4f9eca0a6e5d0d59.png)  
trySplit尝试分割。  
forEachRemaining是forEach的函数操作。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/518470b00aba9098425e0b13be2e1aa3.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/0eb64251356ef912297735e45a6c5432.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/7461c3f4cdb468d2265bc03deebbe10d.png)  
默认的扩容因子是0.75，即，75%扩容。  
HashMap在new的时候不会立即分配内存。  
这里需要注意，**扩容扩的是哈希槽数组的容量，不是扩容整个HashMap的容量。**  
因为HashMap内部使用链表或者红黑树进行存储数据，不存在容量限制。  
只有哈希槽是使用数组存储，有扩容的问题。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/68cb1b53b3fc334e6a8f0bcf8ccc15a1.png)  
如果在初始化的时候指定了大小，那么会设置大小，扩容因子以及扩容阈值。扩容的阈值是指定大小+1.  
当然，指定大小加1是一般情况下。  
实际计算比这复杂：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/bde931b793810932641207e12f1b42e3.png)

### 7.2 put

在7.1中知道，new 了HashMap并不会立即分配内存，而是第一次put操作的时候，会分配内存。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/1e748cf8c2075e704513517a3c7e1500.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/11c7a599ffd9cf857512aae15be764ca.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/dab1172064311905a48eecbf675f9c7c.png)  
如果哈希槽还未分配内存，那么会调用resize进行分配内存。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/140b04aec62617c5968220ec240dd381.png)  
使用无参构造，此时旧的大小和阈值都是0.  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/552e18ad452ebccc0c7e3a9d4b65d126.png)  
默认大小是16，默认扩容阈值是16*0.75=12  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/0ac0e2cacd5cb7249b3dbee4867a885b.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/64d5e527e844e3ae1c545591670262da.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/04a8078df2ad1539950c621c7abd3074.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/6e228c90abf6857e38e9f1c877129de4.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/63b380fda22f5fb79f3cb0ab2728b673.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/1607e22e5fd6b4ed92c1b1d604f54861.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/c6721eac2de03887b7805af47fb13130.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/35a3c311ddc1463377cb90b0d7cb07ea.png)  
所以说，当单个哈希槽下的节点个数大于等于8的时候，就会进行树化，从链表转为红黑树。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/45006c0ddf46f98127532e4c9b1770f8.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/fdafb20ff95b66de97ab6298976a195d.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/6cb5ef7db0cf3a1b50377eeb045ccc79.png)  
++modCount版本号增加  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/47f40ca3bb2b9ae924855328fcab67b7.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/6c8346f14065b56e3212985b15e2a7fb.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/07107b42163440791614de3cc29d2b1f.png)

### 7.4 hashCode

HashMap的hashCode是将所有的节点的hashCode累加后的hashCode  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/3de0b9276254ef963ebdc0c7da3ed0c2.png)
