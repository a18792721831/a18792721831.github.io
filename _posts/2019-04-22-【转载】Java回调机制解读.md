...
![image](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/5c40fb6a6b9a0d3da2db1e3511d25dca.png)

同步调用是最基本并且最简单的一种调用方式，类A的方法a()调用类B的方法b()，一直等待b()方法执行完毕，a()方法继续往下走。**这种调用方式适用于方法b()执行时间不长的情况** ，因为b()方法执行时间一长或者直接阻塞的话，a()方法的余下代码是无法执行下去的，这样会造成整个流程的阻塞。

（2）异步调用

![image](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/308110628e462dd17155984a8e63e8c5.png)
...
![image](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/bebb51bb41f6480b90e05f56b9cbe7ad.png)
