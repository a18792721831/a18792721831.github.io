...
layout: post
title: "Go-知识测试-性能测试"
date: 2024-07-01 10:45:51 +0800
categories: [golang, go, go 测试, go 性能测试, go Benchmark]
description: "性能测试会执行多次，然后计算平均耗时。性能测试要保证测试文件以_test.go结尾。测试方法必须以开头。测试文件可以与源码处于同一目录，也可以处于单独的目录。_go 性能测试"
keywords: golang, go, go 测试, go 性能测试, go Benchmark
---

> **文章信息**
> - 原文链接：https://jiayq.blog.csdn.net/article/details/140094738
> - 发布时间：2024-07-01 10:45:51
> - 阅读量：1
> - 分类：Golang专栏收录该内容, 订阅专栏
> - 标签：#golang, #go, #go 测试, #go 性能测试, #go Benchmark

## 摘要

文章浏览阅读1.3k次，点赞27次，收藏19次。性能测试会执行多次，然后计算平均耗时。性能测试要保证测试文件以_test.go结尾。测试方法必须以开头。测试文件可以与源码处于同一目录，也可以处于单独的目录。_go 性能测试
...
#### Go-知识测试-性能测试
  ...
  * [1\. 定义](<#1__5>)
  * [2\. 例子](<#2__10>)
  * [3\. testing.common 测试基础数据](<#3_testingcommon__55>)
  * [4\. testing.TB 接口](<#4_testingTB__124>)
  * [5\. 关键函数](<#5__152>)
  *     * [5.1 testing.runBenchmarks](<#51_testingrunBenchmarks_153>)
    * [5.2 testing.B.runN](<#52_testingBrunN_158>)
    * [5.3 testing.B.StartTimer](<#53_testingBStartTimer_163>)
    * [5.4 testing.B.StopTimer](<#54_testingBStopTimer_176>)
    * [5.5 testing.B.ResetTimer](<#55_testingBResetTimer_189>)
    * [5.6 testing.B.Run](<#56_testingBRun_205>)
    * [5.7 testing.B.run1](<#57_testingBrun1_273>)
    * [5.8 testing.B.run](<#58_testingBrun_277>)
    * [5.9 processBench](<#59_processBench_301>)
    * [5.10 tetsing.B.doBench](<#510_tetsingBdoBench_305>)
    * [5.11 testing.B.launch](<#511_testingBlaunch_313>)
    * [5.12 testing.B.SetBytes](<#512_testingBSetBytes_366>)
  * [6\. 数据统计](<#6__404>)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/55d1b86757f65ad1845e78fc5a03c541.png#pic_center)

通过输出可以知道 Without 执行了 403447 次，平均每次 2596 纳秒  
With 执行了 329895次，平均每次 3357 纳秒  
也就是说，在1000的容量下，预先分配反而慢。我猜测是显式调用make花费了时间。  
加大容量,n=1000_0000  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/0664f706ff19eafc73acd439aa07839e.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/bbdea9930b8281fda4dec00a4bf594e2.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/b12100ad8d35f66ec11e9706ec36a89b.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/a6656150b88b3a2e3dae51a7ccec8ec9.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/540b3403b4a020bcef46861089d8409e.png#pic_center)
...
执行结果  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/5c8cbe8f20fbe4944d43fbf1949e4fe2.png#pic_center)

## 6\. 数据统计

在测试开始时，会把当前内存值记录下来：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/10469b8772799cdaeececddf7a9f0193.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/cf22cf6a6f2a0333bef580b947d31aa7.png#pic_center)
