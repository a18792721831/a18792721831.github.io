...
![ApplicationContext](https://i-blog.csdnimg.cn/blog_migrate/e9192a3e0c79422c2d14da6034a6f06f.png)
...
![image-20200820193932622](https://i-blog.csdnimg.cn/blog_migrate/1dc534ea00f556eabb7f1dcd84029340.png)
...
![image-20200820194405030](https://i-blog.csdnimg.cn/blog_migrate/ae1e66ad780ddd7ed5ed6500d51b7039.png)

新增bean

![image-20200820194429874](https://i-blog.csdnimg.cn/blog_migrate/3a64b64f62756f485240efbb4734bb29.png)

新增beans.xml

![image-20200820194453702](https://i-blog.csdnimg.cn/blog_migrate/91de51cf41b36b3d67a8f7c06740973a.png)

然后注释掉spring boot中原来的代码，添加我们的代码

![image-20200820194528160](https://i-blog.csdnimg.cn/blog_migrate/f80c241db46816ceddf75a9e1bcb112c.png)

运行

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/388b54a94299bbd7b3e36069988b421e.gif#pic_center)
...
![image](https://i-blog.csdnimg.cn/blog_migrate/b7040a0aa6dc958cf90c93f82afe4a8c.png)
...
![image-20200820202243293](https://i-blog.csdnimg.cn/blog_migrate/60a2baf00db79ed8d2c406be5032353c.png)

## XmlBeanDefinitionReader

这是`XmlBeanDefinitionReader`的UML图

![image](https://i-blog.csdnimg.cn/blog_migrate/9dfeb9a9a336352cbb3c34e3a0f5bb8f.png)
...
![image](https://i-blog.csdnimg.cn/blog_migrate/df0aea21c34600e8c73dcc0063d48645.png)
...
![image-20200822144138299](https://i-blog.csdnimg.cn/blog_migrate/4890fa5a55fd9cf9795fd1a6083effcc.png)
...
![image-20200822143834013](https://i-blog.csdnimg.cn/blog_migrate/c71b7a8b29f0debc91b8e76c516e9d2d.png)
...
![image-20200822145454635](https://i-blog.csdnimg.cn/blog_migrate/de2c8329fc75ab59f9578985ccdaa07c.png)

得到了配置流后，就交给了`XmlBeanDefinitionReader`进行解析。

![image-20200822145716503](https://i-blog.csdnimg.cn/blog_migrate/f94bfca2538cd99f12d99c377294d99b.png)

![image-20200822145729279](https://i-blog.csdnimg.cn/blog_migrate/1606b3b93e0a48a8ccf45365cf0b0c65.png)

在初始化父类的时候，忽略装配一些类

![image-20200822145953961](https://i-blog.csdnimg.cn/blog_migrate/21c9e1d87fd56974ac359ad8947634c1.png)

### 加载Bean

![image](https://i-blog.csdnimg.cn/blog_migrate/bc2ef0b85999b0b0ec020d43ae3d7577.png)
...
![image-20200822152733034](https://i-blog.csdnimg.cn/blog_migrate/87d9657835eb3c99225170adefd67ed9.png)

`EncodeedResource`主要用于对资源文件的编码进行相应的编码处理。

![image-20200822154027396](https://i-blog.csdnimg.cn/blog_migrate/e433597edf24dd33f0d7ae415b7c1b3c.png)

如果设置了编码属性，会使用相应的编码作为输入流的编码。

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/7d5b2c0094e87b28c523c888e897d901.png#pic_center)

这个方法主要是将重新编码的输入流转换为SAX的InputSource对象，同时如果指定了编码，需要设置相关的属性。

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/0cba3f7f86a66cac164df4b61a5b79a0.png#pic_center)
...
![image-20200822181516391](https://i-blog.csdnimg.cn/blog_migrate/1186d27f1fd7988026835b6093516de9.png)

![image-20200822181600969](https://i-blog.csdnimg.cn/blog_migrate/351f1e7bd94e7ba802f457583e964112.png)
...
![image-20200822172452919](https://i-blog.csdnimg.cn/blog_migrate/b9f3433e10c1896892c26447b435235e.png)

DTD文件里面是一些ENTITY节点

![image-20200822172528742](https://i-blog.csdnimg.cn/blog_migrate/18dae4275a96f3e98d9c5b33566d050e.png)
...
![image-20200822181110255](https://i-blog.csdnimg.cn/blog_migrate/03471343fb0c98bd010fd76f3771b410.png)
...
![image-20200822181621954](https://i-blog.csdnimg.cn/blog_migrate/c4ed5df0b6782a391efa109cc2ec7821.png)

调用了`DocumentLoader`接口的方法：

![image-20200822181704320](https://i-blog.csdnimg.cn/blog_migrate/a6d66d6eaa7c647cf7258352a4222321.png)

这个接口只有一个实现类`DefaultDocumentLoader`

![image-20200822182350576](https://i-blog.csdnimg.cn/blog_migrate/da6615ac08e9c73f7d2321779a1ecbdf.png)

### BeanDefinitions

将配置文件转换为`Document`后，就会根据`Document`对象进行注册Bean.

![image-20200822182535309](https://i-blog.csdnimg.cn/blog_migrate/afeebca0708880428d1f18d636826439.png)

注册bean：

![image-20200822183351796](https://i-blog.csdnimg.cn/blog_migrate/46742fcdd26d62db1ff2bf4efde75f6b.png)

首先通过反射获取`BeanDefinitionDocumentReader`的对象。

![image-20200822183516072](https://i-blog.csdnimg.cn/blog_migrate/16e7d3c71dd96978c2ec8a2e0ec1aef4.png)

然后记录下本次注册前，已经有多少个bean被注册了。

然后调用`documentReader`对象进行注册。

![image-20200822183726851](https://i-blog.csdnimg.cn/blog_migrate/ab095445ba4a1e91a13bc57519e01298.png)

使用的还是默认实现

![image-20200822183745063](https://i-blog.csdnimg.cn/blog_migrate/524edf0cc2ba4cc1f25daf518e100960.png)

在使用documentReader进行读取时，首先读取的是root节点。

![image-20200822183936937](https://i-blog.csdnimg.cn/blog_migrate/ec4b16ac2f5d74f5050b36e3d84d9055.png)

接下来就是解析的核心逻辑了：

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/4dc4518882b24207a46c6c92b4051443.png#pic_center)

首先处理profile

![image-20200822184440549](https://i-blog.csdnimg.cn/blog_migrate/a44e019790cf8bfd1d947aaa13b870dd.png)

解析bean就是这里了

![image-20200822184809167](https://i-blog.csdnimg.cn/blog_migrate/b259a7d8d80f3ec02fd2ddeea2729e94.png)

![image-20200822185320840](https://i-blog.csdnimg.cn/blog_migrate/64423447940b3f6ba7999a74705673e1.png)
