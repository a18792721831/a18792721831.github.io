...
date: 2024-05-16 19:38:45 +0800
categories: [golang, go, go 并发管理, chan, channel]
description: "channel 作为协程间通信的类型，用来在协程间传递信息是基本能力，而通过灵活的使用 channel ，可以实现各种各样复杂的并发控制。"
keywords: golang, go, go 并发管理, chan, channel
---

> **文章信息**
> - 原文链接：https://jiayq.blog.csdn.net/article/details/138972958
> - 发布时间：2024-05-16 19:38:45
> - 阅读量：588
> - 分类：Golang专栏收录该内容, 订阅专栏
> - 标签：#golang, #go, #go 并发管理, #chan, #channel

## 摘要

文章浏览阅读588次，点赞5次，收藏7次。channel 作为协程间通信的类型，用来在协程间传递信息是基本能力，而通过灵活的使用 channel ，可以实现各种各样复杂的并发控制。
...
[薅羊毛：Baidu Comate，200积分换20元京东E卡](<https://comate.baidu.com/zh/shopping?inviteCode=y21fpcef>)
