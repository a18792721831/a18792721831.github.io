...
执行如下：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/31ebd7d19e5dd0f9af1509000207c5e6.png)
...
执行结果  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/91fc42bd0ec05946d4171fb25c370ed1.png)
...
>  比如：  
>  ![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/f9b045771844cf69b9237274131ef23b.png)

> 就无法推导出来返回值的类型了  
>  而且显式调用，必须全部指定，不能指定部分类型  
>  ![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/c88200ddba50ebcd5b00bcea8cd4db5f.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/822105afa36c117f4dc4b3c1902beba8.png)
...
执行结果  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/66c3fcd8ea211d339cfa4854193d7f77.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/13c0bd53bf49152d8cea66791a86137b.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/f306b36826597c241e521913cabdbe4c.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/f9e213a4230ffd1d1b1ee4d26a359bb1.png)

但是不能将interface泛型用于interface方法集合  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/aecf02d2f120f5b718234a8838c3275f.png)

但是如果显式的声明了泛型，那么就可以使用  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/9af79744f5cb405b8e3493b5e61d6ceb.png)

并且该interface的方法集合也能像之前一样实现  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/285983263e1fcda8db8ae4069ebe0511.png)

因为在定义interface泛型的时候，限定是int，所以只有int类型才算是实现了方法  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/f8f23587af15eae551323d0ce41e8dcd.png)

> 这样来看，使用interface泛型类型，可以限定什么样的方法算是实现。

如果将float64加入到interface泛型中，那么float64的方法也算是实现  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/a77550bef089651084db5695a9b6f7c1.png)
...
不使用近似类型  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/7317e5ce8969af58d338a4da7c4fa26d.png)

使用近似类型  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/7bde41d0d1077eecd0165739d1a7c971.png)

只要底层类型相同，就能使用泛型函数

> 需要注意的是，`~`之后的类型必须是某个底层类型，换句话说，一个类型的底层类型不是自身就不能使用`~`。  
>  ![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/7f1f8a8390954e50b6e02bb8a68474d6.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/6fc1dea2faf2b413bc9739c8c5c9a8f5.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/c3a698b8f1715cd8d1c87e9c594e3dc9.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/50fb99de36dc2760916a61b21b4d7b55.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/cf83f2968cf126b917dd11be16b594e4.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/1daef587d0a6d7019cb50ab6e65d53ad.png)
