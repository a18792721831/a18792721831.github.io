...
#### Go-知识测试-子测试
  ...
  * [4\. 选择性执行](<#4__44>)
  * [5\. 子测试并发](<#5__53>)
  * [6\. testing.T.Run](<#6_testingTRun_124>)
  * [7\. testing.T.Parallel](<#7_testingTParallel_176>)
  * [8\. 子测试适用于单元测试](<#8__225>)
  * [9\. 子测试适用于性能测试](<#9__235>)
  * [10\. 总结](<#10__241>)
  *     * [10.1 启动子测试 Run](<#101__Run_242>)
    * [10.2 启动并发测试 Parallel](<#102__Parallel_248>)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/f1f0cd53b22146aaa67412ad9fda87a7.png#pic_center)
...
比如我们在B里面在调用A：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/9d5af817041946dc8e8df63923797b28.png#pic_center)

执行后：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/84ff7c95c5604517b8ba8d97295d05af.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/a022c13380a64506a75e830e4a26e51a.png#pic_center)

> 选择性执行的字符串，是包含匹配，不是严格的正则匹配。

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/0f524b965e1c4d14a9415d9f1a602259.png#pic_center)
...
执行后用时超过6秒  
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/d260ead84736495ca9f1cbe067ee0f6e.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/f4ae849c5f1a48b79462fc46656448fe.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/e6096540794f4c94bb74e50914718046.png#pic_center)

在testing.tRunner中，有对子测试相关的支持  
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/f6f3c78f78e947cab0cbb4bdc40c62d6.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/1636ad69b2c14889877ddad57f5050a0.png#pic_center)
