...
#### Go-知识map
  ...
  * [1\. map 的用法](<#1_map__1>)
  *     * [1.1 map 的声明](<#11_map__3>)
    * [1.2 map 的初始化](<#12_map__9>)
    * [1.3 map 的使用](<#13_map__17>)
    * [1.4 并发不安全](<#14__32>)
    * [1.5 空map](<#15_map_36>)
  * [2\. map 的原理](<#2_map__59>)
  *     * [2.1 map 的数据结构](<#21_map__60>)
    * [2.2 bucket 的数据结构](<#22_bucket__80>)
    * [2.3 hash 冲突](<#23_hash__104>)
    * [2.4 负载因子](<#24__111>)
  * [3\. 扩容](<#3__127>)
  *     * [3.1 扩容条件](<#31__128>)
    * [3.2 增量扩容](<#32__132>)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/6adea25ee54e625e3fcd2eb3f5a0fd4d.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/89e458995634fb7e89b036a11f01faf9.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/857b5ef66d3ce0fe16f1e2c6adbd3423.png#pic_center)
...
比如如下是一个map的简易结构：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/00cb26c40e64ac328af707f85f21d5e5.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/7542f3cbff13f666e40922d231bdbe66.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/76590a2981ca30654085f59ea1c59629.png#pic_center)

此时负载因子等于7，大于6.5，再次添加key-value就会触发扩容，扩容之后再写入。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/bf4772da41b8e551aa6008a585e9b751.png#pic_center)
...
扩容完成后可能得情况：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/442bbaf45196e4838a3305a50061a4b3.png#pic_center)
...
比如如下map:  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/57bb7c71f14a7c206af5aaab5fd04134.png#pic_center)
...
比如，判断map是否处于拷贝中：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/666212065e6a0d05769b522cbd99474d.png#pic_center)

如果oldBuckets不为空就是处于拷贝中。  
在比如，map扩容：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/b88060e33dae523b3cc71f65c6069500.png#pic_center)

在加上map针对32位和64位，以及string做了优化，源码非常难懂：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/2227b7d195b898dc3fa8c8f4146d0ba1.png#pic_center)