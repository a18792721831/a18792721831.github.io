...
layout: post
title: "Go-知识map"
date: 2024-03-09 11:47:16 +0800
categories: [golang, go, map, 源码, map扩容]
description: "Go 语言中map的底层使用Hash表实现，并发不安全。_go map[string]"
keywords: golang, go, map, 源码, map扩容
---

> **文章信息**
> - 原文链接：https://jiayq.blog.csdn.net/article/details/136580151
> - 发布时间：2024-03-09 11:47:16
> - 阅读量：1
> - 分类：Golang专栏收录该内容, 订阅专栏
> - 标签：#golang, #go, #map, #源码, #map扩容

## 摘要

文章浏览阅读1.6k次，点赞25次，收藏20次。Go 语言中map的底层使用Hash表实现，并发不安全。_go map[string]
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/adbb833cc981933429aec740c292dd05.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/4ea6d8592f93e1e508d7e7d369768a69.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/9102563993309c46b476a4fc86fdf8a6.png)
...
比如如下是一个map的简易结构：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/92ca3aac63b57de34dcf9024c9a26a08.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/be6b14316fdc78dfb4832d6ef8873af6.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/c95808e29bef88985794fa738e4b05f5.png)

此时负载因子等于7，大于6.5，再次添加key-value就会触发扩容，扩容之后再写入。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/d8edb0f61b3c46261e95ecd24c2dda09.png)
...
扩容完成后可能得情况：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/641cc29f38af77b64e929855cb0a74bf.png)
...
比如如下map:  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/97c9bec99ddeddaa1d2f2ade0f8261d5.png)
...
比如，判断map是否处于拷贝中：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/b4d4c78b09e8fcbb483094750b01ee5e.png)

如果oldBuckets不为空就是处于拷贝中。  
在比如，map扩容：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/1ca850191a6bfadbd40ae64f176650db.png)

在加上map针对32位和64位，以及string做了优化，源码非常难懂：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/c5c8ead5b201bc0d129b5291d40f01cc.png)
