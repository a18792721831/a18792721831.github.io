...
目标网址：![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/eebae9e30d37ee5777927f3d5d9f6047.png)  
没错，本次要挑战的就是搜索第四名的网站。  
为什么选择这个网站？  
第一个需要花钱才能看，破解太难。  
第二个打开太慢。  
第三个有访问验证。  
第四个访问地址加密，总体较为容易破解。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/b343378357dc905b4e6f06bfe00be862.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/b2ed8c091b89ae745395523723a7c1ed.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/7601eb22a8eede9880de4edf3d7f84db.png)

## 2.目标网站行为分析

首先这个漫画网站会监听大多数的按键与鼠标事件，所以，如果漫画正文的相关的js文件加载后就无法使用浏览器的一些工具。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/2c2c8dcf3ae8f8a36db90b408d9774c5.png)  
所以需要提前打开工具，然后访问目标漫画网站。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/4eb2731f9df1f0170d77c9718038cf90.png)

## 3.目标文件依赖加载分析

首先使用PostMan访问漫画正文网站，获取网站的静态代码：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/04cd9ffd60041747fc875da9983de850.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/106a838962f1291a71687e57bdfbcf72.png)  
使用工具查看当我们访问漫画正文时，静态代码会引入哪些js，以及哪些css或者是ajax：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/3631d47991a22556a389a5d11a9f5d8d.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/fb0a943cd42d831b52576f85193764ff.png)  
这就是访问静态的html代码时，访问的加载的依赖文件。  
其中yg.html就是我们用postMan获取的html代码。  
style.js?..从名字上就能看出是加载css样式的代码。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/e94f15a6d2eb4a63f069490d2b02d33c.png)  
让这个网页动起来的就是  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/18a706922be8c8c5add8beb1e6275cb1.png)  
文件。  
这个文件是一段js代码，我们也使用idea格式化分析。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/378b00b36b49c6d0e930f6dbe2edc613.png)  
代码太长，就不贴了。  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/8b13b88d4b400f65130769632d78eb77.png)  
通过对元素的检查与HTML的分析：

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/5d977b16638557c1da40615929d9f35d.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/b880243d1cf76476e0e461fc40f6e127.png)  
可以得到下一章的相对地址，为什么是相对地址？  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/73a73a837f9316f9acda64b6f4b83db4.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/51fae5ca59641a7f56d747efc0d86dac.png)  
前面部分都相同。  
然后会在HTML代码中获取到最重要的一个信息：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/37a855e28a0e546acf059f3295bedf95.png)  
这个信息包含了一整个章节的所有信息。
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/95b99971ef39c3c6b05548594c9103b0.png)  
image_suffix图片的后缀(没什么用)

这个对象很重要。  
<https://www.manhuatai.com/nitianxieshen/yg.html>  
这个是某一页的地址  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/36e770e62c61f47a8df144b413279711.png)  
<https://www.manhuatai.com/nitianxieshen/1.html>  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/28e98d63f9cf0f4fda7202216717a6b7.png)  
这是第二章节的地址。  
<https://www.manhuatai.com/nitianxieshen/yg.html>  
<https://www.manhuatai.com/nitianxieshen/1.html>  
前面部分完全相同：  
<https://www.manhuatai.com>  
访问这个地址![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/d12fef673f7a4e99923a9e9c24377ae9.png)  
就是网站的首页地址  
...
所以我们想个比较简单的办法：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/652958ab6b47a7cf124db0b88669968d.png)  
js的最后是一个document的对象的写的方法，那而且这一行代码特别的长有5299个字符，这尼玛，真长。  
仔细的看下，这不就是我们拿到的html代码吗？  
只不过这里用js生成的，我们把双引号去掉。  
然后格式化：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/550fe38cf3d82f24124fb82a98a1b4dd.png)  
发现只是样式，没用。。。。苦恼，继续看js代码。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/8ab29932c1c33c780ea804d90188b2bb.png)  
发现有一个__cr的对象，这个对象有好多的方法。  
那么我们就大概看下这个对象有些什么方法（只看方法名猜，先不要看具体的方法实现）  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/77018d9f84bd3789bf025355e5f950d5.png)  
搜索查看：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/d8481b4a4a22ecc02e25b89bfa3fbdc2.png)  
有这么一句，和真实地址有关系啊：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/96bbf3cc1060de15806dbd298340b6a8.png)  
进入这个方法查看：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/06c8d1359504f310404efe49d2a91542.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/d299603149ec82a6964bb8f5629e4aa8.png)  
这不就是一些js的代码吗，虽然没学过前端什么语言，但是根据js和jquery大概能看懂这两行，大概就是创建一个img标签，src地址就是![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/93bae5d388aa7ea47e5acb77cf79d976.png)  
继续进入这个方法：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/17e8391a355bf2bcccc6c144ecb593f1.png)  
在这个方法中看到了一个熟悉的名字：  
mh_info,这个不就是我们获取的从HTML代码中得到的json对象吗？  
我们需要的应该是n  
为什么呢？  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/5b7ab697008254b5226d30242af00587.png)  
还记得这个地址吗？  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/c0ef452eaf0f5aa843d527c0f6b4b358.png)  
发现图片的真实地址中加密的部分解密后第一个字符总是大写的N这个字符，那么为什么是这个字符呢？  
这个字符有什么特殊吗？  
所有的漫画都是这个字符吗？  
我们换个漫画看下  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/34f01cf7883d5efd0357cc6ef36c22c5.png)  
我很机智的发现了解密的方式：  
迁移法。  
加密方法–迁移法
...
发现还是不能访问。  
既然不能访问，那么就回去继续看js代码：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/45c26af8cda12736aa03765ba927f148.png)  
通过这里分析：  
n=  
https  
+  
...
页码放在解密后的地址后面。  
验证下：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/11c42d01c69cee8873faa9c5a093f99d.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/62151dcd9823d8e0e00b2cf84c4bed92.png)  
与猜想一致。
...
一个文件一个方法。  
项目结构  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/6c4f9a538fa26337479e69392e877053.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/912f5ec912f22030bb4f2d87932b189c.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/6df025dfb2a669318a09b26f7e68f389.png)  
1.首先使用浏览器的f12获取此本漫画的图片地址解密标识字符：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/7f89f0755bc4ba9cd81221ac537e6264.png)  
N  
2.在文件管理器中创建一个保存的目录：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/d943786813f9d4bed05febf1cb245c6f.png)  
3.拷贝地址启动程序：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/576cc687cf6462bcdbf66e0c91c6f0bc.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/ca0327b0f84556bb782adf8bdd77816d.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/9155285547c0837cf3da2ccf40cacda5.png)  
因为是多线程，所以下载顺序完全是乱的  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/85ca545e5be24dbe8c0807b405a85297.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/8507fba0a5c0998fe548f6a92e002fd5.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/308db48ae2710e9b8c6df656a1b3f1a0.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/02bf5dc07ff342d718de438875e3ce10.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/9e3306ac1fe9fdd1df2cf3f5536edd4c.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/2f560803904e77de68683f2a1c947e2e.png)  
发现最后一章少了一张图片，去网站看下，发现少的这一张图片是  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/08df20cb35171135c66470a7a0ae8c9e.png)  
是广告页，不要也罢。
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/f881798fc4dd5a33ddb265f0ebc08459.png)
