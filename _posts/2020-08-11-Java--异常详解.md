...
#### Java--异常详解
  ...
  * [异常分类](<#_1>)
  * [Throwable](<#Throwable_7>)
  * [Error](<#Error_41>)
  * [Exception](<#Exception_47>)
  *     * [RuntimeExceptionn](<#RuntimeExceptionn_53>)
    * [CheckedException](<#CheckedException_59>)
  * [异常处理方式](<#_70>)
  *     * [throw](<#throw_72>)
    * [throws](<#throws_76>)
    * [jvm自动抛出](<#jvm_80>)
  * [throw和throws的异同](<#throwthrows_86>)
  * [异常的捕获](<#_105>)
  * [异常调用链](<#_138>)
...
![image-20200811183913204](https://i-blog.csdnimg.cn/blog_migrate/96728a15236e7b7a846c2926fe15578e.png)
...
![image-20200811185444881](https://i-blog.csdnimg.cn/blog_migrate/b80c8a31927e3130a538798dbd304303.png)

## Error

Error 类是指 java 运行时系统的内部错误和资源耗尽错误。应用程序不会抛出该类对象。如果出现了这样的错误，除了告知用户，剩下的就是尽力使程序安全的终止.

![image-20200811185821287](https://i-blog.csdnimg.cn/blog_migrate/267770c434734d7f9630ba592b85c1fa.png)

## Exception

![image-20200811185851801](https://i-blog.csdnimg.cn/blog_migrate/7e4c5764f382a8fead981defb245b242.png)
...
![image-20200811190156250](https://i-blog.csdnimg.cn/blog_migrate/a22f182adf16c4a141e067d6c3ee0dbc.png)

### throws

![image](https://i-blog.csdnimg.cn/blog_migrate/a22f182adf16c4a141e067d6c3ee0dbc.png)

### jvm自动抛出

![image-20200811190226930](https://i-blog.csdnimg.cn/blog_migrate/3259a6593260ac0e4609ff433f42e7ca.png)

![image-20200811190236707](https://i-blog.csdnimg.cn/blog_migrate/49686609225f71e1b5b6b3edbbba98b3.png)
...
![image-20200811192641646](https://i-blog.csdnimg.cn/blog_migrate/2f03fd31cdc7ded78726d2939547de0d.png)
...
![image-20200811193704999](https://i-blog.csdnimg.cn/blog_migrate/e1b739af4c11f12b3ed41146694efd45.png)
...
![image-20200811194520023](https://i-blog.csdnimg.cn/blog_migrate/c1878d42ced6941aeb5b5d105d8307a4.png)

这样整个异常调用链就完整了：

![image-20200811194652221](https://i-blog.csdnimg.cn/blog_migrate/e0c9aaa9946bc6acb2da643d618979c1.png)
...
![image-20200811200302026](https://i-blog.csdnimg.cn/blog_migrate/c3800a1e0b3cded160a96377477133cb.png)