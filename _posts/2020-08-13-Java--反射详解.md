...
#### Java--反射详解
  ...
  * [动态语言](<#_1>)
  * [反射机制--运行中知道全部的类和属性](<#_5>)
  * [反射API](<#API_11>)
  *     * [Class](<#Class_20>)
    * [Field](<#Field_191>)
    * [Method](<#Method_293>)
    * [Constructor](<#Constructor_364>)
  * [反射步骤](<#_404>)
  * [获取Class](<#Class_410>)
  *     * [==getClass()==](<#getClass_412>)
    * [==class关键字==](<#class_419>)
    * [==forName()==](<#forName_425>)
  * [获取实例对象](<#_431>)
  *     * [==Class的newInstance()==](<#ClassnewInstance_433>)
    * [==Constructor的newInstance()==](<#ConstructornewInstance_437>)
...
![image-20200813182038074](https://i-blog.csdnimg.cn/blog_migrate/48f77944bcd6fc0e4319417d3dfe9621.png)
...
![image-20200813193135758](https://i-blog.csdnimg.cn/blog_migrate/f97c181bd061d42a318824aab657c6f5.png)

注释掉全部的setter、getter方法

![image-20200813193216175](https://i-blog.csdnimg.cn/blog_migrate/8a3384307bf02f0d1c7bb2e3624716db.png)

重写toString方法

![image-20200813193234214](https://i-blog.csdnimg.cn/blog_migrate/648ef38af419b1546384b813e9cf0a00.png)
...
![image-20200813194057725](https://i-blog.csdnimg.cn/blog_migrate/960101cae30b1f5a59c2abe0461d9959.png)

### Method

新增不同权限的方法：

![image-20200813194145511](https://i-blog.csdnimg.cn/blog_migrate/d597b139b0e9cf1ed358a02625a65f9c.png)
...
![image-20200813200246028](https://i-blog.csdnimg.cn/blog_migrate/2f7e2d0e6c1d75cd896310097f00c3bb.png)
...
![image-20200813201321220](https://i-blog.csdnimg.cn/blog_migrate/744fd86733d3b2bcbfddea1bbdeac12d.png)

### Constructor的newInstance()

![image-20200813201418144](https://i-blog.csdnimg.cn/blog_migrate/5d81589ae51e0d409291e17b8b0ba2f1.png)