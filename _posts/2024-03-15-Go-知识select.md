...
layout: post
title: "Go-知识select"
date: 2024-03-15 15:41:14 +0800
categories: [golang, go, select原理, select源码, select详解]
description: "- select仅能操作chan.- 每个case语句仅能处理一个chan，要么是读chan,要么是写chan.- 多个case语句的执行顺序是随机的。- 存在default语句，select将不会阻塞。- 使用select读取chan时，应该尽可能检查读取是否成功，确定数据是否可信。_go select chan"
keywords: golang, go, select原理, select源码, select详解
---

> **文章信息**
> - 原文链接：https://jiayq.blog.csdn.net/article/details/136741702
> - 发布时间：2024-03-15 15:41:14
> - 阅读量：1
> - 分类：Golang专栏收录该内容, 订阅专栏
> - 标签：#golang, #go, #select原理, #select源码, #select详解

## 摘要

文章浏览阅读1.5k次，点赞19次，收藏21次。- select仅能操作chan.- 每个case语句仅能处理一个chan，要么是读chan,要么是写chan.- 多个case语句的执行顺序是随机的。- 存在default语句，select将不会阻塞。- 使用select读取chan时，应该尽可能检查读取是否成功，确定数据是否可信。_go select chan
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/cb204513d20a5f03fe04486eea285d5f.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/0fc0c0abb5f5bcb7145b764c1809326f.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/cbde5e3838ffddfcb5a931c2dac5aae9.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/0334145005d260419bee3e5b1b5c2bf5.png)

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/87381754b11a1a01a9989666ba5ca584.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/2a3c59a08a7953ecaf1d5a5b660b06d0.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/104a29137497b2fa5dfe2f631b1a9092.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/63ffcccf9401a6013028b35fbf0d5f93.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/ee7809c6cda981dea875fff45cd158f8.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/0a02b9a967e60050e4ab3ba4cb35eb7c.png)

这里有个知识点：`//go:linkname`。  
可以看到在`reflect/Value.go`中的`Select`函数调用了`rselect`函数，但是`rselect`函数没有方法体：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/9af49d79b803bbe612d547b09ace9a0e.png)

而`rselect`函数的方法体在`runtime/select.go`中：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/aceb102500300fc5cb2e067d67614e40.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/754f7be060ffce5d4049764bc757608a.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/f14113a210173a7ef5865f0c3eaeab67.png)
