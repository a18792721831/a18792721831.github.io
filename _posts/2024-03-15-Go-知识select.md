...
#### Go-知识select
  ...
  * [1\. select 的特性](<#1_select__7>)
  *     * [1.1 chan读写](<#11_chan_8>)
    * [1.2 返回值](<#12__132>)
    * [1.3 default](<#13_default_178>)
  * [2\. select 经典使用](<#2_select__182>)
  *     * [2.1 永久阻塞](<#21__183>)
    * [2.2 快速检错](<#22__195>)
    * [2.3 限时等待](<#23__209>)
  * [3\. 实现原理](<#3__225>)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/679e94b3fdcb37de27d26caeb7ea6116.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/ac820adbf04f261aa7131f95eead9cf8.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/7e324dd3797948f7164237718d4f370a.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/2fe21f5721985ddd3392b7f77579a88c.png#pic_center)

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/2dd021d0e716c29484f1e3ac710602fa.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/4f2c56855ab8412dbf10148ae2fc81d2.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/6af7479b03d1b41e90f3bf130b2dc952.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/5205f5d1583956173c6b0d9336fc5661.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/63f88860776cf6ce0746ed3afef25f0e.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/5b106013b2c0ab3da965298234c421e0.png#pic_center)

这里有个知识点：`//go:linkname`。  
可以看到在`reflect/Value.go`中的`Select`函数调用了`rselect`函数，但是`rselect`函数没有方法体：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/0eeec2c6da207c801f10c2dc14e498f8.png#pic_center)

而`rselect`函数的方法体在`runtime/select.go`中：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/65ef463eece67f1e5eb6df0a354910b2.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/3c5438e4222c12dbba342787ffde21d9.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/48e457117a6bba9bc83b6a042c4a22ae.png#pic_center)
