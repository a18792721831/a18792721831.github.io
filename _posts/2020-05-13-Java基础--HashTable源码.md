...
HashTable的类图   
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/f349849ed5b01ab228b2ecab1be6d0f2.png)   
...
Map接口实现了泛型，接受两个类型。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/dc01c137165d4a5f40b58b71c983737b.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/f0f92bd37fb51ad6a943b945477d2b64.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/a0ccb25053ff7dd3fd0a6cea3839420f.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/5827b1a1412ff3b3dff53f2cd869bf6d.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/47a41955ea00c12bafb7c7a455d53eff.png)
...
数据结构类似下图  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/ba561d5626b8ff4507d407ecd9bfa15c.png)  
...
也就是  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/7c3274b5b50be64a9c4e5a501193552c.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/a4811cc0b253ac754e350e78e8123efd.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/f781716e5798cf28ebc82002a8e6d115.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/8cf40c3173bbba61e655c3ff4f48cb9e.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/9c0ec49e79915a5cb908171b7d4bc86d.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/a492d8488ff9eff1363866de0c923eb7.png)  
...
初始的阈值是哈希槽的数量的扩容因子倍。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/4353f7c91f817e496d1cdd48b910b57a.png)  
扩容因子默认是0.75.  
也就是说，HashTable的扩容是75%扩容的。(哈希槽扩容，注意和元素可存储的个数的扩容不同)  
ArrayList是100%扩容。（移位实现）  
Vector也是100%扩容。(Vector还可以定义不可扩容)  
LinkedList不存在扩容问题。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/16e3c106d532710c01518ccadec251ac.png)  
HashTable如果不指定初始哈希槽的大小，那么可以存放11*0.75=8.25即8个元素。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/139edee92ec5266ed91cd48cf0084e45.png)  
根据已有集合创建hashTable的时候，如果集合的元素个数的2倍大于11个。那么将哈希槽设置为集合元素数量个，否则就设置为11个。  
所以，HashTable的默认初始哈希槽的大小就是11.

#### 3.3.2 HashTable的普通方法

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/8a65e7cc925e586e83a4c00df6f5dbfa.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/62f27e3be0b3a853bbaeead9c459871e.png)  
可以发现，通过创建迭代器的模式不同，实现不同属性的遍历。

#### 3.3.4 contains方法

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/screenshot/cvm/evermemos_storage_test_20260106_144405.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/235118416b0c6ad84e8dd1cefd752da9.png)

#### 3.3.6 get方法

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/c3d7074d975d93b7ba91e8f8f3cdd702.png)  
get方法是通过计算key的hash值，找到key对应的哈希槽，然后遍历哈希槽内的元素链表。如果key的hashCode和key都相等，就返回这个key对应的value.

#### 3.3.7 put方法

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/48bcfe5a24732adc623153f6d5412a18.png)  
...
如果键值都不相同，那么就需要增加元素：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/0261948188d5e2f6fa8371e087b70763.png)  
在增加元素的时候，首先会将版本号加1.  
...
重新哈希：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/f0e5cf2967bb26d18406c81a871442e0.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/4528713b04d454f25da97d64025bb7f0.png)  
clear方法是将每个哈希槽对应的链表清空。

#### 3.3.11 clone

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/93a44c26aa447f664c8a069d735c38cf.png)  
克隆方法会循环克隆当前的hashTable的属性，不过会清空版本号。

#### 3.3.12 迭代访问

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/7a9a70649e2e4c4ee6df69df08f687e7.png)因为内部的迭代器都是私有的，为了实现外界使用迭代器，需要暴露方法，这个暴露方法就是获取内部私有的迭代器。  
外界持有的是接口的实例。  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/bd472ab1e597fc8fdf29213f3c46c2ff.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/a7d6dbe07a48ed10202c3e04a687dc4f.png)  
获取指定键的值，如果不存在，返回默认值。

#### 3.3.15 forEach

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/ef09264e17cbed9281b0e55b47b5a6fc.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/372b578b76155fbf3ba732f8bb50d73b.png)  
在remove时，会将版本号加1，所以，remove前后，版本号变了。

#### 3.3.17 replace

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/08d55602982e376cedf3dbec0da61c89.png)  
replace前后，版本号也是不变的。

#### 3.3.18 writeObject

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/50593624be344c28e2fdc33619e03b48.png)  
这个方法是在序列化写的时候用到，对应的还有序列化读的方法。

#### 3.3.19 readObject

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/abc92613fac8434db11a3785a5e4d573.png)
