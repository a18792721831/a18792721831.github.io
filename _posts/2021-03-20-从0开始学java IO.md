...
#### 从0开始学java IO
  ...
  *     * [设计思想](<#_87>)
    ...
    *       * [Socket](<#Socket_95>)
      * [IO 流](<#IO__133>)
    * [BIO实例 -- 多人聊天室](<#BIO___161>)
    *       * [客户端服务端双阻塞](<#_173>)
      * [客户端阻塞服务端并发](<#_260>)
      * [客户端阻塞服务端复用线程并发](<#_314>)
      * [客户端并发服务端复用线程并发](<#_451>)
  * [NIO](<#NIO_778>)
  *     * [BIO VS NIO](<#BIO_VS_NIO_780>)
    * [设计思想](<#_800>)
    * [核心类](<#_806>)
    *       * [Buffer](<#Buffer_808>)
      * [Channel](<#Channel_828>)
      * [Selector](<#Selector_838>)
    * [NIO 实例 -- 本地文件拷贝 -- 编程步骤](<#NIO______879>)
    * [NIO 改写 BIO 项目 -- 多人聊天室](<#NIO__BIO____1182>)
    * [改写前 VS 改写后](<#_VS__1793>)
  * [AIO](<#AIO_1829>)
  *     * [BIO VS NIO VS AIO](<#BIO_VS_NIO_VS_AIO_1833>)
    * [设计思想](<#_1879>)
    * [核心类](<#_1893>)
    * [AIO 实例 -- 回音壁 -- 编程步骤](<#AIO______1923>)
    * [AIO 改写 NIO 项目 -- 多人聊天室](<#AIO__NIO____2311>)
    * [改写前 VS 改写后](<#_VS__2795>)
    * [扩展](<#_2807>)
  * [总结](<#_2847>)
...
![image-20210127202017664](https://i-blog.csdnimg.cn/blog_migrate/9cfc7c60c60f811bad716c405e243e73.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/53961f908de7af7d413e77f58c4a1a16.gif)

但是我们需要的是多人聊天室，虽然上面的例子实现了客户端和服务端通信。但是多人聊天可不止一个客户端。

在上面的例子中，我们如果启动两个客户端，此时第二个客户端会阻塞。

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/84ec50ce16d282fd57a706da110d23dc.gif)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/02536182cccf0a48800b15604e8a1946.gif)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/981934dc9ccede8d251f38d1e6fe2589.gif)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/fd8bb6a83746a1df8dbdf12b848d2345.gif)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/992022ed5f55dd31d272eded6ed34001.gif)
...
![image-20210130162347580](https://i-blog.csdnimg.cn/blog_migrate/a065e85929f56a03dbb32ae8ff3b3302.png)

Channel的UML图

![image-20210130162606952](https://i-blog.csdnimg.cn/blog_migrate/3dd1f0947c1ebf0758b32f3b208dca7b.png)
...
![image-20210130181858877](https://i-blog.csdnimg.cn/blog_migrate/d6301e431c9f41f19682d30d0a9af42a.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/b612e806afc64c7fb08c0bee473189e9.gif)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/cc7061321cfa17322a2c46f90f0add0c.gif)
...
![image](https://i-blog.csdnimg.cn/blog_migrate/45b0c11d2f10cb14309a8a6d46e96363.jpeg)
...
![image-20210320125722631](https://i-blog.csdnimg.cn/blog_migrate/09d6d48d54c4c4e66de4ec6093ef98fa.png)
...
![image-20210320144255013](https://i-blog.csdnimg.cn/blog_migrate/6db5c244e5c9932c8a624714030e5a02.png)
...
![image-20210320144701067](https://i-blog.csdnimg.cn/blog_migrate/531609839feea6860454e65be94c2ee2.png)

最终调用的是

![image-20210320144746932](https://i-blog.csdnimg.cn/blog_migrate/f8105392ce277c5f0d5200a4f76d7cc5.png)
