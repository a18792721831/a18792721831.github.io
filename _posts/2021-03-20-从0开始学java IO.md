...
layout: post
title: "从0开始学java IO"
date: 2021-03-20 14:58:44 +0800
categories: [java IO, 多线程, BIO, NIO, AIO]
description: "从0开始学java IOIO 发展BIO设计思想核心类SocketIO 流BIO实例 -- 多人聊天室客户端服务端双阻塞客户端阻塞服务端并发客户端阻塞服务端复用线程并发客户端并发服务端复用线程并发NIOBIO VS NIO设计思想核心类BufferChannelSelectorNIO 实例 -- 本地文件拷贝 -- 编程步骤NIO 改写 BIO 项目 -- 多人聊天室改写前 VS 改写后AIOBIO VS NIO VS AIO设计思想核心类AIO 实例 -- 回音壁 -- 编程步骤AIO 改写 NIO 项目_从零学java io"
keywords: java IO, 多线程, BIO, NIO, AIO
---

> **文章信息**
> - 原文链接：https://jiayq.blog.csdn.net/article/details/115027890
> - 发布时间：2021-03-20 14:58:44
> - 阅读量：343
> - 分类：java同时被 3 个专栏收录, 订阅专栏, java核心, 多线程
> - 标签：#java IO, #多线程, #BIO, #NIO, #AIO

## 摘要

文章浏览阅读343次。从0开始学java IOIO 发展BIO设计思想核心类SocketIO 流BIO实例 -- 多人聊天室客户端服务端双阻塞客户端阻塞服务端并发客户端阻塞服务端复用线程并发客户端并发服务端复用线程并发NIOBIO VS NIO设计思想核心类BufferChannelSelectorNIO 实例 -- 本地文件拷贝 -- 编程步骤NIO 改写 BIO 项目 -- 多人聊天室改写前 VS 改写后AIOBIO VS NIO VS AIO设计思想核心类AIO 实例 -- 回音壁 -- 编程步骤AIO 改写 NIO 项目_从零学java io
...
![image-20210127202017664](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/9cfc7c60c60f811bad716c405e243e73.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/53961f908de7af7d413e77f58c4a1a16.gif)

但是我们需要的是多人聊天室，虽然上面的例子实现了客户端和服务端通信。但是多人聊天可不止一个客户端。

在上面的例子中，我们如果启动两个客户端，此时第二个客户端会阻塞。

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/84ec50ce16d282fd57a706da110d23dc.gif)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/02536182cccf0a48800b15604e8a1946.gif)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/981934dc9ccede8d251f38d1e6fe2589.gif)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/fd8bb6a83746a1df8dbdf12b848d2345.gif)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/992022ed5f55dd31d272eded6ed34001.gif)
...
![image-20210130162347580](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/a065e85929f56a03dbb32ae8ff3b3302.png)

Channel的UML图

![image-20210130162606952](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/3dd1f0947c1ebf0758b32f3b208dca7b.png)
...
![image-20210130181858877](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/d6301e431c9f41f19682d30d0a9af42a.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/b612e806afc64c7fb08c0bee473189e9.gif)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/cc7061321cfa17322a2c46f90f0add0c.gif)
...
![image](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/45b0c11d2f10cb14309a8a6d46e96363.jpeg)
...
![image-20210320125722631](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/09d6d48d54c4c4e66de4ec6093ef98fa.png)
...
![image-20210320144255013](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/6db5c244e5c9932c8a624714030e5a02.png)
...
![image-20210320144701067](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/531609839feea6860454e65be94c2ee2.png)

最终调用的是

![image-20210320144746932](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/f8105392ce277c5f0d5200a4f76d7cc5.png)
