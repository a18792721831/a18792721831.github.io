---
layout: post
title: "【转载】Java 9 中的 9 个新特性"
date: 2019-04-16 15:57:33 +0800
categories: [java新特性, java9]
description: "Java9引入了一系列重要更新，包括模块系统、JShell交互式环境、改进的Javadoc、集合工厂方法、增强的Stream API、私有接口方法、HTTP/2支持、多版本兼容JAR等。这些特性不仅提升了开发效率，还增强了代码的封装性和安全性。"
keywords: java新特性, java9
---

> **文章信息**
> - 原文链接：https://jiayq.blog.csdn.net/article/details/89335317
> - 发布时间：2019-04-16 15:57:33
> - 阅读量：365
...
文章浏览阅读365次。Java9引入了一系列重要更新，包括模块系统、JShell交互式环境、改进的Javadoc、集合工厂方法、增强的Stream API、私有接口方法、HTTP/2支持、多版本兼容JAR等。这些特性不仅提升了开发效率，还增强了代码的封装性和安全性。

---

转自：<http://www.importnew.com/24528.html>
    ...
    <div class="entry-meta">
    	...
    	<p class="entry-meta-hide-on-mobile">2017/05/09 | 分类： <a href="http://www.importnew.com/cat/basic" title="查看 基础技术 中的全部文章" rel="category tag">基础技术</a> | <a href="http://www.importnew.com/24528.html#respond" title="《Java 9 中的 9 个新特性》上的评论">0 条评论</a>
    
    	 | 标签： <a href="http://www.importnew.com/tag/java">Java</a></p>
...
分享到： [](<http://www.jiathis.com/share?uid=1745061>)
    ...
    <div class="entry">
    	...
    	<div class="copyright-area">原文出处： <a ref="nofollow" target="_blank" href="https://www.oschina.net/translate/java-9-new-features?print">oschina</a></div>
    

Java 8 发布三年多之后，已经于在2017年9月21日发布了。 你可能已经听说过 Java 9 的模块系统，但是这个新版本还有许多其它的更新。 这里有九个令人兴奋的新功能。
...
| 1  2  3  4  5 |  `module blog {` ` ` `exports com.pluralsight.blog;` ` ` `requires cms;` `}` |
|---------------|------------------------------------------------------------------------------|

我们可以如下展示模块：

[![image](http://incdn1.b0.upaiyun.com/2017/05/5410f460518a3d7570bbb9c30fa196da.png)](<http://www.importnew.com/24528.html/110834_5dcr_2896879>)
...
[![image](http://incdn1.b0.upaiyun.com/2017/05/ab670628226f3b6d7d665f54c8669c28.png)](<http://www.importnew.com/24528.html/110852_fzpk_2896879>)
...
[![image](http://incdn1.b0.upaiyun.com/2017/05/3dbe50499ff59393262f30dfe88d9a97.png)](<http://www.importnew.com/24528.html/110905_3rha_2896879>)
...
| 1  2  3  4  5  6  7  8  9 |  `HttpClient client = HttpClient.newHttpClient();` `HttpRequest req =` ` ` `HttpRequest.newBuilder(URI.create(` `"http://www.google.com"` `))` ` ` `.header(` `"User-Agent"` `,` `"Java"` `)` ` ` `.GET()` ` ` `.build();` `HttpResponse<String> resp = client.send(req, HttpResponse.BodyHandler.asString());` |
|---------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
