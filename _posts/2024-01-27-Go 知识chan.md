...
layout: post
title: "Go 知识chan"
date: 2024-01-27 17:09:56 +0800
categories: [golang, go, chan, 管道, 并发]
description: "本文详细介绍了Go语言中chan的基本概念、数据结构、操作原理，包括定义、操作限定、读写规则，以及如何利用select和for-range进行高效并发控制。重点讲解了环形队列、等待队列和chan的关闭机制。"
keywords: golang, go, chan, 管道, 并发
---

> **文章信息**
> - 原文链接：https://jiayq.blog.csdn.net/article/details/135885482
> - 发布时间：2024-01-27 17:09:56
> - 阅读量：1
> - 分类：Golang专栏收录该内容, 订阅专栏
> - 标签：#golang, #go, #chan, #管道, #并发

## 摘要

文章浏览阅读1.8k次，点赞28次，收藏20次。本文详细介绍了Go语言中chan的基本概念、数据结构、操作原理，包括定义、操作限定、读写规则，以及如何利用select和for-range进行高效并发控制。重点讲解了环形队列、等待队列和chan的关闭机制。
...
执行结果：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/bb99bcf14cb1a7fd9e579ffe2d027ccd.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/4ba2698bb6d88aa91d1c221cb8837278.png)![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/2a2ab87e0580350e98b83b8e95bfd636.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/3cded24f1e1f5ad8402f305ce3243e57.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/95ff45c107680dc073bb6eed6f7376a9.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/cdae6eb0168a4c3fb8e11a2ef3477c40.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/e773cf17fd37a5c48614be941474954e.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/57cce91a67d635ed3cd463f802f2afa5.png)
