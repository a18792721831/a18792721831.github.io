...
#### Go-知识依赖Module
  ...
  * [1\. 介绍](<#1__1>)
  * [2\. module 的定义](<#2_module__16>)
  * [3\. 语义化版本规范](<#3__37>)
  * [4\. 使用例子](<#4__51>)
  *     * [4.1 hello world](<#41_hello_world_52>)
    * [4.2 初始化 module](<#42__module_57>)
    * [4.3 管理依赖](<#43__71>)
  * [5\. module 发展](<#5_module__88>)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/38b1789502ca4e1bb6aae311f516e23b.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/8d9c833b0c4d46759632bcf48965487f.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/4406989fca6044c8a54f22a9dac80613.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/c9f998d9c25f4b188ac6a80bcde52207.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/174d7a68078e41069a9ddc18a2c469e8.png#pic_center)

在开始编译前，使用 `go get` 下载依赖包  
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/5c585c94e5774e52bc7b6eec1146fdcf.png#pic_center)

go get 总是获取依赖的最新版本，如果 `github.com/google/uuid` 发布了新的版本，那么输出的版本信息会相应地变化。  
并且该命令会修改 go.mod 文件  
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/d197b8eeee61462791a32bb280be3ec5.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/c6a963a19ca549afbac1bee286e3b3c1.png#pic_center)
