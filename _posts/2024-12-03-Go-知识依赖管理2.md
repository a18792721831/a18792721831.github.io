...
#### Go-知识依赖管理2
  ...
  * [1\. go.sum](<#1_gosum_1>)
  *     * [1.1 go.sum 文件记录](<#11_gosum__7>)
    * [1.2 生成](<#12__28>)
    * [1.3 校验](<#13__53>)
    * [1.4 校验和数据库](<#14__59>)
  * [2\. 模块代理](<#2__66>)
  *     * [2.1 GOPROXY 介绍](<#21_GOPROXY__67>)
    * [2.2 代理协议](<#22__77>)
    *       * [2.2.1 获取模块列表](<#221__82>)
      * [2.2.2 获取模块元素数据](<#222__93>)
      * [2.2.3 获取 go.mod 文件](<#223__gomod__101>)
      * [2.2.4 获取代码压缩包](<#224__107>)
      * [2.2.5 获取模块的最新可用版本](<#225__112>)
      * [2.2.6 下载过程](<#226__119>)
    * [2.3 观察下载步骤](<#23__123>)
  * [3\. GOSUMDB 的工作机制](<#3_GOSUMDB__141>)
  *     * [3.1 环境变量](<#31__143>)
    * [3.2 GOSUMDB 的引入背景](<#32_GOSUMDB__152>)
    *       * [3.2.1 正确的模块版本](<#321__153>)
      * [3.2.2 go.sum 的不足](<#322_gosum__158>)
    * [3.3 GOSUMDB 的工作机制](<#33_GOSUMDB__163>)
    *       * [3.3.1 GOSUMDB 是什么](<#331_GOSUMDB__164>)
      * [3.3.2 校验流程](<#332__173>)
      * [3.3.3 数据库数据来源](<#333__178>)
  * [4\. GOSUMDB 的实现原理](<#4_GOSUMDB__182>)
  *     * [4.1 数据库的数据结构](<#41__187>)
    * [4.2 数据库查询接口](<#42__197>)
    *       * [4.2.1 查询数据库整体信息](<#421__199>)
      * [4.2.2 查询模块版本 Hash](<#422__Hash_208>)
      * [4.2.3 查询任意节点](<#423__214>)
  * [5\. 客户端审计](<#5__219>)
  *     * [5.1 确保对端规范](<#51__221>)
    * [5.2 确保对端没有被篡改](<#52__240>)
    * [5.3 整体校验过程](<#53__248>)
    * [5.4 缓存查询结果](<#54__254>)
  * [6\. 第三方代理](<#6__261>)
  *     * [6.1 模块代理](<#61__265>)
    *       * [6.1.1 如何配置带三方代理](<#611__266>)
      * [6.1.2 可用的第三方代理](<#612__270>)
    * [6.2 校验和数据库代理](<#62__276>)
    * [6.3 安全性](<#63__285>)
  * [7\. 私有模块](<#7__290>)
  *     * [7.1 私有模块配置](<#71__293>)
    * [7.2 私有代理场景](<#72__297>)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/ee53d9386f7349b197b2127e32ad6950.png#pic_center)

go get 命令首先会将该依赖包下载到本地缓存目录`$GOPATH/pkg/mod/cache/download` 下，该依赖包是一个后缀为 .zip 的压缩包  
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/91d400c7193f4407ae167f705e7fbf52.png#pic_center)
