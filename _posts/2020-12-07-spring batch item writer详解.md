...
![image-20201205161807119](https://i-blog.csdnimg.cn/blog_migrate/8754c3f473d484e24a421e1c1d3a0a32.png)
...
![image-20201205162205841](https://i-blog.csdnimg.cn/blog_migrate/89f1a6e72ec30d43961e93c61e617146.png)
...
![image-20201205171611159](https://i-blog.csdnimg.cn/blog_migrate/bfc748c899fee4ec557529fe25ed2f36.png)

接着创建JdbcBatchItemWriter的写入组件

![image-20201205175642396](https://i-blog.csdnimg.cn/blog_migrate/b4f6f9c36d199ed1818178f2f9de0ac3.png)
...
![image-20201205175728974](https://i-blog.csdnimg.cn/blog_migrate/574efd4ec186b91e54df913b616c2490.png)

数据库中查看结果

![image-20201205175753272](https://i-blog.csdnimg.cn/blog_migrate/1a9ef548eb911f305de7ece85db72e24.png)

我们这里使用的是问号，也可以使用变量名

![image-20201205175908220](https://i-blog.csdnimg.cn/blog_migrate/945f5254735eab5acd3412f558c39816.png)

这次少写入点，写入10个

![image-20201205175955925](https://i-blog.csdnimg.cn/blog_migrate/b3ecddcdecd78276ecd9f0f1824aadf6.png)

数据库中也有了

![image-20201205180012514](https://i-blog.csdnimg.cn/blog_migrate/2c3d7da27383a805d212869948b697a3.png)
...
![image-20201205181431233](https://i-blog.csdnimg.cn/blog_migrate/360dbae49d88538de74719e4270874c4.png)

接着配置Jpa的EntityManagerFactory

![image-20201207085031412](https://i-blog.csdnimg.cn/blog_migrate/473772718b06cc73fd68b66f0d190026.png)

除此之外，还需要配置Jpa事务管理器(Jpa有默认的，事务级别和spring相同，做了适配)

![image-20201207085115566](https://i-blog.csdnimg.cn/blog_migrate/9c05ac4cdb95d6cb1e8f52b2cf662346.png)
...
![image-20201207085204404](https://i-blog.csdnimg.cn/blog_migrate/c90b0d05796e6c35462655ba19dccfab.png)

数据库查询

![image-20201207085219456](https://i-blog.csdnimg.cn/blog_migrate/1f7488ab236d4014bb43004c5b14dcf9.png)
...
![image-20201207085246245](https://i-blog.csdnimg.cn/blog_migrate/134a78413477b59ef4dc04dad8a8f458.png)

接着配置MyBatis的SqlSessionFactory

![image-20201207091441242](https://i-blog.csdnimg.cn/blog_migrate/71cdcf57e934a3b451518a54283e3a18.png)

增加MyBatis的接口

![image-20201207091507759](https://i-blog.csdnimg.cn/blog_migrate/37c50b1abc546cefd1e648424c598c50.png)

以及XML文件

![image-20201207091524061](https://i-blog.csdnimg.cn/blog_migrate/7939752a799a1e3580a82d29d346299f.png)

增加扫描的Mapper注解

![image-20201207091541289](https://i-blog.csdnimg.cn/blog_migrate/eeb41429974a7d1a592a0ce613443a47.png)

设置实体的作用域

![image-20201207091602935](https://i-blog.csdnimg.cn/blog_migrate/596d64c818eda97210121d31035ab902.png)

创建MyBatis的写入器

![image-20201207091628017](https://i-blog.csdnimg.cn/blog_migrate/c345cc9ce62e61a7a37121626a6a0d82.png)

assertUpdates默认为true，表示当1条记录都没有被插入时，会抛出异常。设置为false，则忽略这个问题 ，即使没有数据被插入，也不会抛出异常。

同样的，对于MyBatis，一定要保证Mapper先读取

![image-20201207091753651](https://i-blog.csdnimg.cn/blog_migrate/8c6d9f449337f044c7b1d7a8cda039c2.png)
...
![image-20201207091828518](https://i-blog.csdnimg.cn/blog_migrate/b284290aac4d2e4f45c798be18168786.png)

数据库记录

![image-20201207091839177](https://i-blog.csdnimg.cn/blog_migrate/947c759a57eecb0a66a1354f0aef91a9.png)
...
![image-20201207163521980](https://i-blog.csdnimg.cn/blog_migrate/473d3def63ef5c1c200a48e877ee1de3.png)

以及一个MyBatis的Writer

![image-20201207163543642](https://i-blog.csdnimg.cn/blog_migrate/b5c7d8f0cbe8b0c7a4de4aecb87f2497.png)

最后全部扔到组合写处理器中

![image-20201207163628356](https://i-blog.csdnimg.cn/blog_migrate/b119466034cbcfb6f78075576fc3c828.png)

启动

![image-20201207163647478](https://i-blog.csdnimg.cn/blog_migrate/87459ad8842f22ea34cd1b5ca610696e.png)

发现数据库中只存入了5条记录，而不是预期的15条

![image-20201207163718146](https://i-blog.csdnimg.cn/blog_migrate/47ed286cd2a2a6b1bf876e0062189069.png)

而多数据源，或者不同种类的数据源，是能预期写入的。

如果我们去除Jpa，只有Mybatis

![image-20201207170612018](https://i-blog.csdnimg.cn/blog_migrate/79d43cf8b339f72e2abe83bc0d4e9185.png)
...
![image-20201207170631566](https://i-blog.csdnimg.cn/blog_migrate/807cade282fc42dedd624c60071cb7bb.png)

但是数据库中存入了10条

![image-20201207170653236](https://i-blog.csdnimg.cn/blog_migrate/f469c6c218dfaeb093b0e8281d5e18f0.png)
...
![image-20201207171108204](https://i-blog.csdnimg.cn/blog_migrate/9d565f6ba09bac1f4f72d4d7c2d56512.png)

我们在原有代码的基础上，增加两个方法：

![image-20201207180641769](https://i-blog.csdnimg.cn/blog_migrate/51cfedf0ccade55cfd044dcb03791062.png)

在真正持久化的时候，会标出是哪个方法写入的

![image-20201207180753074](https://i-blog.csdnimg.cn/blog_migrate/f05a9a886c590c25765e01c8bb68be30.png)

接着创建这两个写入器

![image-20201207180823601](https://i-blog.csdnimg.cn/blog_migrate/6921235c1eedf08b1890b353465485cf.png)

然后配置

![image-20201207180947762](https://i-blog.csdnimg.cn/blog_migrate/3b71db53f7720c717496d53912e7bac5.png)

当然还有其他的路由器

![image-20201207181010896](https://i-blog.csdnimg.cn/blog_migrate/e23bbc14fa3cb073051cbe9b96644661.png)
...
![image-20201207181050915](https://i-blog.csdnimg.cn/blog_migrate/d3dc045df050a742f6e12e5b35c2f92c.png)

数据库中的记录

![image-20201207181104861](https://i-blog.csdnimg.cn/blog_migrate/2babc603c47d497cf5e711058f36e49f.png)
...
![image-20201207182847104](https://i-blog.csdnimg.cn/blog_migrate/0b6bfc807b2b369a4dff14b44ea10900.png)

接着创建相关的job使用这个Service

创建写入器，并使用

![image-20201207182931454](https://i-blog.csdnimg.cn/blog_migrate/aa1c0147de8d5f0c140dc8a5c1e3de6b.png)
...
![image-20201207183000079](https://i-blog.csdnimg.cn/blog_migrate/001b29e2c0314de150326dec5129ab5e.png)
...
![image-20201207184313388](https://i-blog.csdnimg.cn/blog_migrate/2510923284cb4b2b3a9c52a56b61ffbf.png)

创建写入器

![image-20201207184348357](https://i-blog.csdnimg.cn/blog_migrate/4bdfc1932b7d6cc622d11fb13d8bb716.png)
...
![image-20201207184416996](https://i-blog.csdnimg.cn/blog_migrate/86d9b9d406915fd6b9949291ea592599.png)
...
![image-20201207184701772](https://i-blog.csdnimg.cn/blog_migrate/74f2fe4c2ec74075cdfbe0481b8f3fd6.png)

我们实现一个自己的写入器

![image-20201207185759822](https://i-blog.csdnimg.cn/blog_migrate/3c11e5981f4a9a0a864a9b6b0603c11a.png)
...
![image-20201207190044965](https://i-blog.csdnimg.cn/blog_migrate/ce63e34b2083cd6456fd9e88f1e5fe89.png)

在不修改参数的情况下重启

![image-20201207190217501](https://i-blog.csdnimg.cn/blog_migrate/b8cd4776612159c49187673f03b57b6e.png)

它还是从0开始，从头开始。不能接着上次写入失败的记录或者chunk继续写入。

初次之外，如果写入器比较简单，也可以直接使用lambda表达式写

![image-20201207191012080](https://i-blog.csdnimg.cn/blog_migrate/37e206783c5f47bcf6b857ef96ab509e.png)

其结果是相同的

![image-20201207191226254](https://i-blog.csdnimg.cn/blog_migrate/0ef91f95dc289932a595a640d95bf190.png)
...
![image-20201207193706090](https://i-blog.csdnimg.cn/blog_migrate/99ae7acbe212ba861ceb25bfc1c6d8c5.png)

核心写入逻辑相同，遇到4的时候异常,但是需要用到我们保存的number

![image-20201207200147357](https://i-blog.csdnimg.cn/blog_migrate/538ff742cf98af85c4b7519271916751.png)  
然后使用自定义的可重启的写入器

![image-20201207193804849](https://i-blog.csdnimg.cn/blog_migrate/4d741318318fc53d1e5e6b1cbcc85b18.png)
...
![image-20201207193830028](https://i-blog.csdnimg.cn/blog_migrate/4d951f36d21791f2df1ccc9f511ca81b.png)

第二次执行

![image-20201207200019839](https://i-blog.csdnimg.cn/blog_migrate/28d6419aac184ffd78058fc42fff328f.png)
...
![image-20201207200342737](https://i-blog.csdnimg.cn/blog_migrate/3d0d7a1d72a9fa694a64b804ee454430.png)

实现自己的写入拦截器

![image-20201207200717094](https://i-blog.csdnimg.cn/blog_migrate/f63479566c41a48bcedc03916ba0c21e.png)

然后使用自己的写入拦截器

![image-20201207201616598](https://i-blog.csdnimg.cn/blog_migrate/af80d653edc65fb0f9d514c50f44e31d.png)

运行结果

![image-20201207201713814](https://i-blog.csdnimg.cn/blog_migrate/9a4ba2e3ca3568cb0da5cc9c86f1901b.png)
...
![image-20201207201913282](https://i-blog.csdnimg.cn/blog_migrate/b8e9d633219aa4597271e94299bb32df.png)

使用

![image-20201207201945952](https://i-blog.csdnimg.cn/blog_migrate/316f11bb062831b9c59e19e226d6d829.png)

结果

![image-20201207202332235](https://i-blog.csdnimg.cn/blog_migrate/23b6ca6e0b40116a88b9d88ff23754d8.png)
...
![image-20201207202730315](https://i-blog.csdnimg.cn/blog_migrate/426a1c8cbb4ed48f8e6880c162d844c4.png)

执行结果

![image-20201207202859319](https://i-blog.csdnimg.cn/blog_migrate/7e848389c75cdd09899399c7ff0d6989.png)

确实是因为我们抛出的异常导致失败

![image-20201207202933349](https://i-blog.csdnimg.cn/blog_migrate/4aa1662a712bf215408872676e2d8b37.png)

Job失败

![image-20201207202843291](https://i-blog.csdnimg.cn/blog_migrate/28b7cbaa6b6deaf87407903704cc6715.png)
