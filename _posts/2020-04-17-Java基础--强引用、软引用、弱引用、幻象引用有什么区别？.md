...
#### 强引用、软引用、弱引用、幻象引用有什么区别？
  ...
  * [1.定义](<#1_1>)
  * [2.对象可达性分析](<#2_27>)
  * [3.Reference](<#3Reference_36>)
  * [4.ReferenceQueue](<#4ReferenceQueue_46>)
  * [5.显式地影响软引用垃圾收集](<#5_66>)
  * [6.诊断 JVM 引用情况](<#6_JVM__73>)
  * [7.Reachability Fence](<#7Reachability_Fence_76>)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/c2ba82645521a0b965c0b78723635594.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/408ca8b8e5d948ef557072bf4a85fe9f.png)  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/596d94b0fca2141910642bff1d94e9ff.png)  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/4d0b33b02ba257533531324520a5579b.png)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/f78a98c5833031b279489727e5431c35.png)  
