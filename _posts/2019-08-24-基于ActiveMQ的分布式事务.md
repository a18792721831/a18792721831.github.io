...
#### 基于ActiveMQ的分布式事务
  ...
  * [4.代码详解](<#4_267>)
  *     * [4.1 dao](<#41_dao_268>)
    * [4.2 mapper](<#42_mapper_297>)
    * [4.3 mybatis的配置](<#43_mybatis_373>)
    * [4.4 spring配置](<#44_spring_399>)
    * [4.5 多数据源的动态切换](<#45__413>)
    * [4.6 MQ](<#46_MQ_434>)
    * [4.7 定时任务](<#47__490>)
  * [5.项目总结](<#5_493>)
...
补充一张设计草图  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/fe938b2ff436edb797db6cd7b8581625.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/be09f43dc581524cb6f6a453aa0f48af.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/bedbe16f4b506632f13e3e9c5c8e7b07.png)  
增加依赖
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/6e90880f7bb1a845524ade8baf6d5736.png)  
包解析—技术栈解析：  
...
dao使用的是mybatis  
即java代码只定义接口：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/0977b0bd05efaae04d7a8b7b0c1cca50.png)  
...
3.实现mybatis在gradle中加载mapper的xml文件，还有一种方式就是在resources目录下，创建与接口相同的目录结构。比如我的接口的全类名是![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/e4da1bf51daa46b5f9fe14163520a5d6.png)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/e1668be38015144daf724635ba1b914a.png)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/78de4800dd8d6a25754d19868fd53272.png)  
要点：

  * mapper的命名空间要对，以接口的结构为准。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/aa8c869671c119398a1b5c8d0dc7ce48.png)
    * 尽可能的抽取对于表的表名，全字段名，最好定义为可复用的SQL  
这样做的好处就比较多，表结构修改时，只需要修改一处即可，还有就是全字段可以保证查询的SQL查询的属性是全的，不存在属性遗漏的情况。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/8154079f03c71285bdaea9ddb0870ec2.png)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/f901de76a1828f8b75c4ae85a9b7e170.png)  
这个是实现空指针的避免，类似if语句（反例）

### 4.3 mybatis的配置

mybatis的配置文件在resources的mybatis目录中，也是只有一个文件，这个是个人编码风格。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/27eef907a482b2727746a454b368cfa5.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/237c5c16e5312173cf7a4d3cf5a11744.png)  
其中：  
...
详解：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/316745833bff3f31ee4087ff82963db5.png)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/b188aaf22e0e88b4358b79732275cef8.png)  
data包中有两个类：  
MyDataSource类继承AbstractRoutingDataSource实现determineCurrentLookupKey方法  
determineCurrentLookupKey方法返回的是DataSourceManage中的属性，即一个枚举![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/7958cac1973c6b9120a506ee04653bef.png)  
这个枚举就是所有的数据源，枚举含有一个name的属性![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/8928daa6fe843d27aa08e9b358402b05.png)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/a6a8cca2cb45fbca4c2f225b3d5f25b3.png)  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/8955c6de11dd842e68fdbe18a883048d.png)  
