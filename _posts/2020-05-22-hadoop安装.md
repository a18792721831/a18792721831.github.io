...
#### hadoop安装
  ...
  * [2.配置](<#2_12>)
  *     * [2.1 Java](<#21_Java_13>)
    * [2.2 site配置](<#22_site_16>)
    * [2.3 hdfs工作模式](<#23_hdfs_24>)
    * [2.4 yarn配置](<#24_yarn_27>)
    * [2.5 hdfs副本数](<#25_hdfs_30>)
  * [3\. 设置免密登录](<#3__34>)
  * [4\. 启动](<#4__38>)
  *     * [4.1 格式化hdfs](<#41_hdfs_39>)
    * [4.2 启动hdfs](<#42_hdfs_42>)
    * [4.3 启动yarn](<#43_yarn_49>)
  * [5\. 验证](<#5__54>)
  * [6\. 各节点免密登录](<#6__59>)
  * [7\. 子节点加入集群](<#7__74>)
  *     * [7.1 hdfs](<#71_hdfs_88>)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/9bb1e296a790bbb74588b2fd4937467a.png)

### 2.2 site配置

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/4db391853730b5349e0bdf3c298fd57a.png)  
我们修改的主要是core-site.xml,hdfs-site.xml,mapred-site.xml,yarn-site.xml文件  
增加  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/56042644d03c199475c95827546bb4ff.png)  
属性。  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/173296eab126445d97eccd89cc735eb1.png)

### 2.4 yarn配置

在yarn-site.xml中增加：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/5bbcae323e2f328c08a98823a7122497.png)

### 2.5 hdfs副本数

我们有3台机器，设置hdfs的副本数为2.  
在hdfs-site.xml中，增加：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/3af1f5cd0f4115bde496dbd13f04667b.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/96dac5b67c6b54cd9dc47699e56f2ef1.png)

### 4.2 启动hdfs

`./hadoop-daemon.sh start namenode`  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/6f3ec7d3bb88a315b7a82c06deeebdd8.png)  
然后看下日志：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/d0e527f8b43e119fb76cbb18ce3f72d6.png)  
`./hadoop-daemon.sh start datanode`  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/43ae3fcbb807a546f159ba385e83ad15.png)

### 4.3 启动yarn

`./yarn-daemon.sh start resourcemanager`  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/b1b9b1c9c152a73a59b21ed485242bd9.png)  
`./yarn-daemon.sh start nodemanager`  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/f237bc93e73e27ca8186e933e693a063.png)

## 5\. 验证

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/ea34ac0245e311da063772215fe138a2.png)  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/93c4f09797a190c1adab73d2d3519886.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/8de7e2760845cbd4f3d2f80a5dc5f499.png)  
验证：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/b87b2dc205212f1d966c2ab6d9b803c1.png)  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/8ef76b82ba4f6dda0776ca74168199d6.png)  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/2cdb95c1adb07b175641b5d45e4d55ae.png)

## 7\. 子节点加入集群

我们目前配置好了10.0.228.117,其他两个也需要加入。  
首先停止10.0.228.117上面的服务。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/5456cce2455ff317b177480878b148ab.png)  
这个master是spark的，不是hadoop的。  
接着在配置目录的slaves中加入子节点的ip  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/9a3eb1462c95e4aa1735855d88f5e925.png)  
然后将配置目录中的文件拷贝到子节点的配置目录下：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/30a1a96dc0ceb7964f2c50bb27f34eba.png)  
我提前将子节点中的配置目录清空了。  
因为我主节点和子节点的hadoop存放路径不同，所以，需要在环境变量中增加一些配置  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/7f17751893db9c9f2fa350778e792771.png)  
所有目录都需要配置  
（注意，需要三个节点互通）
...
然后启动hdfs(sbin目录)  
`./start-dfs.sh`  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/84ba6975c86f0c68e75a483e280bc0b8.png)  
结果这里有个坑，在启动子节点的时候，使用主节点的环境变量拼接的目录，作为子节点的目录。如果子节点与主节点目录不一致，就会异常。  
为了解决这个问题，我们将子节点的目录与主节点保持一致。  
接着启动：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/1961a1399a551635ade4dbb00e8615b7.png)  
访问10.0.228.117:50070  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/63dbca9739a069e89b94124c21c90ae7.png)
...
验证：  
访问10.0.228.117:8088  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/716f81ce3b4e3339d3b8e319e34e6606.png)  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/7aa9ceae8223d577520271659bd233dd.png)
...
`hadoop fs -ls`  
列出hdfs的目录  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/3b593fe43f7f58c09e76f04bb0e607d4.png)  
`hadoop fs -mkdir /test`  
创建目录  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/c2241c7bcb61d92b29b430dfd3be988b.png)  
`hadoop fs -put /a.out /test`  
上传文件或目录: `source-dir hdfs-dir`  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/5e2ee614eaafc012a348f3b21af977b5.png)  
`hadoop fs -cat /test/a.out`  
查看文件  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/f86a8a996cc404a18e4acf804a4d0be4.png)  
`hadoop fs -get /test/a.out /a.out`  
下载文件或目录  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/1aeddf7d0390c27da689acf31a8d787c.png)  
这是从官网找到的所有的hdfs的操作
