...
#### Zuul 熔断功能不支持配置路由url
  ...
  * [2\. 异常堆栈](<#2__5>)
  * [3\. 复现过程](<#3__92>)
  *     * [3.1 创建zuul项目](<#31_zuul_93>)
    * [3.2 配置zuul](<#32_zuul_95>)
    * [3.3 创建fallback类](<#33_fallback_156>)
    * [3.4 启动eureka server](<#34_eureka_server_248>)
    * [3.5 访问](<#35__250>)
  * [4\. 结论](<#4__253>)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/42aaae359ab8d357232b31c59a26b603.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/d3f6a2c04df7da8e083d11753d176b68.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/52f6edc765a5d52f180d61e1a6997531.png)

### 3.5 访问

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/35bc7523063e6948a3fb3195cf57ad51.png)  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/dae30d943c58ae8f6c7428426506c98a.png)
