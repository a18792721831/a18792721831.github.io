...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/6c2ae549b38d6d73c4a85ff8e042e3b6.png)  
jdk对锁的实现的类主要是2个：ReentrantLock（重入锁），ReentrantReadWriteLock（可重入读写锁）

## 2\. Lock 接口

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/0f8e66c9ca52bd945582fc51eb6a433a.png)
...
执行下看看结果：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/9632a5661e2cbbf578ee2627671c62ad.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/6a437866eff7622ce26d0ec0572b6f79.png)  
...
抽象线程持有类，简称AOS.  
AOS的代码逻辑很简单：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/b7ca6d37b1524158fc17c7858d09d4aa.png)  
...
抽象队列同步器，简称AQS。  
AQS继承了AOS.  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/0ca06405f4240ceb39aa76f03fb6fe21.png)  
...
话不多说，我们首先看看AQS的api.  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/b19e2545df3a33219210f94237a86c38.png)  
请注意重点：
...
使用：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/e77ebf4c4a26d78a214fa0b4974307a7.png)  
...
不管执行多少次都是10W：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/ca5ccd287f62903e656a43ef8cf44d3a.png)  
...
我们在线程内获得锁后，再次尝试获取锁。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/ab46e6407e5295b03842a1078a1fe517.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/1536322a35bb3947584ba3b79bd25fb4.png)  
...
接下来看下执行结果：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/843f95da47bd8d3728ea5c2f1fd1601d.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/12ea2d76526f1a831840549a58f493ea.png)  
还记得吗，AQS继承AOS，而AOS很简单，就是记录哪个线程持有锁(独占模式)  
所以，我们判断请求线程与持有线程是否一致，如果一致才释放，否则不释放。  
我们使用修改后的锁重试上面的例子：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/8f42963d392fdf501abae3aef8d35115.png)  
使用了yeild快多了。  
...
我们定义了一个可重入的独占锁。  
核心方法仍然是获取锁和释放锁的方法:  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/54b237bcec72fc0f6fd572f232f70207.png)  
获取锁：  
所处于空闲，或者请求线程已经持有锁  
锁状态+1  
设置锁持有线程
...
看下最终的结果：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/b900875294048941e7ee29dd013f3474.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/1a827f8a18d18484b3ab1ccb8eb5ff56.png)  
独占锁和共享锁有一个很大区别：  
...
第一个线程获取到门栓锁后，睡眠1秒钟。  
第二个线程获取到门栓锁后，睡眠2秒钟。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/2578bdccfba17cdbe342cffa39d78393.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/e6a38c00fe4005654ee3594b4e779fe2.png)  
通过查看源码，发现Node主要是一个双向链表。  
这个Node结构，怎么理解呢？  
我们首先查看其构造方法：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/b42f090309a110e6ce74d33c9cd8f776.png)  
发现构造主要传入了三个信息：这个Node对应的thread和Node的模式，以及一个等待的int状态量。  
但是通过方法名和传入的类型，对mode这个传入的参数先保持一定的怀疑，貌似不是单纯的模式。  
继续往下看：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/2d185ab338d9770ae05f77677f34a945.png)  
从这里我们可以得到两个信息：  
1.Node记录了是独占的，还是共享的。  
...
继续往下：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/d1894b7b9c32c536efa2d558885e1773.png)  
从这里我们可以得到这个Node的数据结构是双向链表。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/59eb36a897e7f814cc10b2e7f2ad3c89.png)  
...
他是由两个属性共同决定的。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/50c0d20c10d38206280a2d89181f1bca.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/e77ebf4c4a26d78a214fa0b4974307a7.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/fea2c36cc4702f119bf654b29eaa0da3.png)  
在AQS中是没有提供实现的，也就是说，子类如果不实现，会抛出异常。  
根据我们前面他体验的，自定义锁的实现，可以知道：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/ecb75762c935c4be3c95d0f8088bd35d.png)  
我们最终的目的是利用AQS实现锁，所以，接下来的方法将会围绕Lock接口的方法进行展开。

#### 5.6.1 tryLock

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/d5650694a3867d84a82768882a318a2d.png)  
tryLock是最简单的方法，直接调用我们Sync里面实现的加锁的操作。

#### 5.6.2 lock–acquire

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/d0a3287f407f1a2977ee10bf2422bfb3.png)  
锁的加锁操作调用的是AQS的acquire方法，那么，AQS的acquire方法干了什么?  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/f55809427999955299f8b81203355480.png)  
这是时序图：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/f2a393559cb31d5192993f3656a82165.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/617d9bf57516b07b2a472c50b15e3cc9.png)  
在addWaiter中会使用当前线程创建共享的线程节点：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/59710416cfa521c1ae6c0a59068439b2.png)  
在addWaiter方法中，首先创建了当前线程的Node节点，然后获取双向队列的尾，如果尾结点不为空，那么将当前节点的前继节点设置为尾节点，然后将新建的节点设置为尾节点，最后将原来的尾节点的后继节点设置为尾节点：  
①  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/0b1a908fd03af1344dd717bd7bb17c5b.png)  
②  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/fb99fef8e8f8fde1bb51e77f567b7ab9.png)  
③  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/99dfa691010ddf923ea0b9733fdce1c5.png)  
④  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/b35ba424a63677b3f65c75ef8694d1b6.png)

##### 5.6.2.3 enq

新增线程节点到双向列表中，然后会执行enq方法(如果尾节点为空，那么表示双向列表为空)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/925ca5cd74d0ba3aa133c2a517df235d.png)  
...
获取前继节点，或者抛出NPE.  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/352f5f872539339a37999ca6cce4f356.png)
...
阻塞线程，并返回线程中断标志  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/0eade7775cf3405084ed9feb49e90730.png)  
调用LockSupport.park方法，阻塞线程,然后清除线程的中断标志。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/714b13ed59f7d746f90388d9186187ae.png)  
然后返回线程的中断状态，并重置线程的中断标志。

##### 5.6.2.8 cancelAcquire

如果双向列表的头结点在获取锁的死循环中失败，就会退出死循环：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/0dca895533d329fee12d1fc1d5383ba0.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/be9c9cdcb0cd7661f5ae903e29a99237.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/a4e28c780736a55d1b14b35636f46d2a.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/ed77ac33ebc4d81ed07f1773d823456a.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/46e1c6abfc9662cb2a3c114122d551d4.png)  
为什么要中断呢？  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/a0bae56c54818c49f6609d61c21ec798.png)  
得到了中断标志，就要在外层进行中断线程：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/15b904e63ecf20ca92516b6a16830365.png)

#### 5.6.3 unlock-release

首先，unlock中调用的是AQS中的release方法  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/c7e32a7fdb3dc760eb7cf30a5fb9da19.png)  
这是AQS中release方法的时序图  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/7c2861ed48366d46772d8547cebbf9ad.png)  
比起lock方法，这个可就简单多了。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/f24b4fb72427cf51e8b07ac0c0fa01ac.png)  
...
其中有这样一段操作：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/eef890556f83c6841ae2870f04f68b6f.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/6e51794862c7f73a050cd61625205638.png)  
如果线程的中断标志已经是中断了，那么就直接抛出异常，快速结束。  
否则先尝试获取一次锁，如果获取失败，那么就进入doAcquireInterrupttibly方法。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/171ca8691f832d2e64011a04b13ec87b.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/9fea96b05c9d91e15e6b23b62558f041.png)  
首先判断线程的中断标志，如果中断标志已中断，那么，直接抛出中断异常，快速结束。  
否则先调用tryAcquire尝试获取锁，如果没有获取到锁，那么执行doAcquireNanos。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/d17f0656ce8a61d49dd7bdb0b5c2d18d.png)  
...
如果差值大于阈值  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/a11bb2987c0543ad81a100cf51453566.png)  
阈值1毫秒  
那么阻塞线程。  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/73fe94b97aa672997c83a3b51ce04e07.png)  
也是先进去的时候会尝试获取锁，如果获取到锁变量小于0，那么就会调用doAcquireShared方法。  
也就是说，tryAcquireShared如果返回的值 >= 0 那么就获取到了共享锁。  
这是acquireShared的时序图：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/47f413fafc512d9739352a800e99ead5.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/e6723da1eebc2aad709f5caaa12e05ef.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/ad3a37ac08099f21cbc27d20af6ce106.png)  
