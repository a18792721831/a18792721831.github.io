...
layout: post
title: "Go 知识slice"
date: 2024-01-20 15:36:50 +0800
categories: [golang, go, 切片, slice, go细节]
description: "本文详细介绍了Go语言中的slice，包括其定义、实现原理、创建方法（make和切片）、操作（如append、表达式切片、扩展表达式、扩容和拷贝），以及如何避免潜在的越界问题和数据共享问题。"
keywords: golang, go, 切片, slice, go细节
---

> **文章信息**
> - 原文链接：https://jiayq.blog.csdn.net/article/details/135716705
> - 发布时间：2024-01-20 15:36:50
> - 阅读量：1
> - 分类：Golang专栏收录该内容, 订阅专栏
> - 标签：#golang, #go, #切片, #slice, #go细节

## 摘要

文章浏览阅读1.3k次，点赞27次，收藏21次。本文详细介绍了Go语言中的slice，包括其定义、实现原理、创建方法（make和切片）、操作（如append、表达式切片、扩展表达式、扩容和拷贝），以及如何避免潜在的越界问题和数据共享问题。

---

#### Go 知识slice

  * [1\. 什么是slice](<#1_slice_1>)
  * [2\. slice 基础](<#2_slice__3>)
  *     * [2.1 定义](<#21__4>)
  * [2.2 实现原理](<#22__19>)
  *     * [2.2.1 make 创建](<#221_make__25>)
    * [2.2.2 切片 创建](<#222___28>)
  * [2.3 操作](<#23__77>)
  *     *       * [2.3.1 append 追加](<#231_append__78>)
      * [2.3.2 表达式切片](<#232__94>)
      * [2.3.3 扩展表达式](<#233__107>)
      * [2.3.4 扩容](<#234__125>)
      * [2.3.5 拷贝](<#235__130>)
  * [3\. 测试一下](<#3__136>)
  *     * [3.1 len && cap](<#31_len__cap_137>)
    * [3.2 append && 扩容](<#32_append___150>)
    * [3.3 切片表达式](<#33__179>)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/b49a673cec8a369e1ab4a1b4d6c38a5d.png#pic_center)
...
`len(s) = 2`  
`cap(s) = 10 -5`  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/6fa024b1047115ab542ab584ebc2843c.png#pic_center)
...
使用程序验证  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/35733162c274ac2f47a5123e4785390b.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/72cd048bcf5c71f7c18c8df666904cf8.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/8888ba8d938e608d6c51e1bc2b441b02.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/f5af3c4b9da2d194783ea29fe848e850.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/2cf81c5e31cd9ef46f6350410a288a7e.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/c1a048c8af7ccf203876539e97f07829.png#pic_center)