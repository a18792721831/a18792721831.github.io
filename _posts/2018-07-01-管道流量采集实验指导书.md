...
项目较大，是我毕业设计的成果之一，完成整个项目需要的时间大概为8小时（1天，非常熟悉MFC编程），24小时（3天，熟悉MFC编程），48小时（6天，较熟悉），2周（只懂得语法）
  ...
  * [管道流量采集实验指导书](<#管道流量采集实验指导书>)
    * [一、 实验目的](<#一-实验目的>)
    * [二、 实验环境及设备](<#二-实验环境及设备>)
    * [三、 设备简介](<#三-设备简介>)
      * [3.1 RS-485现场总线](<#31-rs-485现场总线>)
      * [3.2 MODBUS协议](<#32-modbus协议>)
      * [3.3 水仓系统](<#33-水仓系统>)
      * [3.4 KJ402-F1矿用本安型水文检测分站](<#34-kj402-f1矿用本安型水文检测分站>)
      * [3.5 GLC30/50矿用磁漩涡流量传感器](<#35-glc3050矿用磁漩涡流量传感器>)
      * [3.6 FD15直流稳压电源](<#36-fd15直流稳压电源>)
    * [四、 实验原理](<#四-实验原理>)
      * [4.1 发送帧](<#41-发送帧>)
      * [4.2 接收帧](<#42-接收帧>)
    * [五、 实验步骤](<#五-实验步骤>)
      * [5.1系统框架构建](<#51系统框架构建>)
      * [5.2外部插件导入](<#52外部插件导入>)
        * [5.2.1串口插件导入](<#521串口插件导入>)
        * [5.2.2折线图插件导入](<#522折线图插件导入>)
      * [5.3对话框设计](<#53对话框设计>)
        * [5.3.1查看参数](<#531查看参数>)
        * [5.3.2历史流量](<#532历史流量>)
        * [5.3.3流量预测](<#533流量预测>)
      ...
      * [5.4单例类](<#54单例类>)
      * [5.5注册表读写](<#55注册表读写>)
      * [5.6折线图、统计表、数据库bean类](<#56折线图统计表数据库bean类>)
      * [5.7对话框功能实现](<#57对话框功能实现>)
        * [5.7.1统计表](<#571统计表>)
        * [5.7.2流量预测](<#572流量预测>)
        * [5.7.3历史流量折线图](<#573历史流量折线图>)
        * [5.7.4原理讲解](<#574原理讲解>)
        * [5.7.5查看参数](<#575查看参数>)
        * [5.7.6设置参数](<#576设置参数>)
        * [5.7.7协议测试](<#577协议测试>)
        * [5.7.8主对话框（实时流量）](<#578主对话框实时流量>)
      * [5.8数据库额外操作](<#58数据库额外操作>)
      * [5.9常见错误](<#59常见错误>)
      * [5.10替换标题栏图标](<#510替换标题栏图标>)
      * [5.11打包](<#511打包>)
    * [六、 总结](<#六-总结>)
