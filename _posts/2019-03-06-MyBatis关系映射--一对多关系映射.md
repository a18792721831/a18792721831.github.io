...
#### MyBatis关系映射--一对多映射
  ...
  *     * [2.1查询映射](<#21_6>)
    ...
    * [2.3不同的方式的分析](<#23_88>)
  * [3.例子](<#3_91>)
  *     * [3.1创建一个MyBatis工程](<#31MyBatis_92>)
    * [3.2 导入jar包](<#32_jar_94>)
    * [3.3实现Java类](<#33Java_96>)
    * [3.4properties](<#34properties_328>)
    * [3.5resource](<#35resource_348>)
    * [3.6mapper](<#36mapper_390>)
  * [4.运行结果](<#4_511>)
  * [5.总结](<#5_554>)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/e6887590cde1d7a788820fc0cf8fb267.png)

### 3.2 导入jar包

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/72669a5916367bbaa41edab7d6fa46fe.png)

### 3.3实现Java类

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/29784146ec09307580157cd864ddc658.png)
