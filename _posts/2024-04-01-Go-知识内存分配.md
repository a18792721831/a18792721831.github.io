...
layout: post
title: "Go-知识内存分配"
date: 2024-04-01 19:58:25 +0800
categories: [go, golang, go 内存管理, go sdk源码, go 内存模型]
description: "Go 程序启动时申请一大块内存，并划分成 spans, bitmap, arena 区域arena 区域按页划分成一个个小块span 管理一个或多个页mcentral 管理多个 span 供线程申请使用mcache 作为线程私有资源，资源来源于 mcentral。_go内存分配"
keywords: go, golang, go 内存管理, go sdk源码, go 内存模型
---

> **文章信息**
> - 原文链接：https://jiayq.blog.csdn.net/article/details/137244768
> - 发布时间：2024-04-01 19:58:25
> - 阅读量：1
> - 分类：Golang专栏收录该内容, 订阅专栏
> - 标签：#go, #golang, #go 内存管理, #go sdk源码, #go 内存模型

## 摘要

文章浏览阅读1.2k次，点赞24次，收藏26次。Go 程序启动时申请一大块内存，并划分成 spans, bitmap, arena 区域arena 区域按页划分成一个个小块span 管理一个或多个页mcentral 管理多个 span 供线程申请使用mcache 作为线程私有资源，资源来源于 mcentral。_go内存分配
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/fae97b4373f16092588d4a4e50141e9d.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/289074ebd4cedde9ac600df4e9eb3e18.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/bcf9d175311fff0ba597ddf27c868c52.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/c93f1a302e8d82979436e7ece255bda7.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/d46e6998b209a7efa03dfbe3789928f6.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/8546bac6608dad4bc65a27971dcc20fd.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/3f3e1726c3aa02385190a35b214a0b80.png)
