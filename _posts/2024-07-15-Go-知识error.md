...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/c69f71bfadc303a88389472c6806aa1b.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/f36ab79d0cb2c19943456b7459272f31.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/214300c8d5e6eb2976a9bbfb8339dec2.png)

### 3.2 fmt.Errorf()

errors.Errorf单调地接收一个字符串参数来构造error，而实际场景中往往需要使用fmt.Sprintf()生成字符串，此时可以直接使用fmt.Errorf  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/fb560da7291ddfc6edffc847f048b1b6.png)
...
使用benchstat分析：  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/6058a29434e07890c371bf516439e274.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/b169162c07258c94a4f95d28d0e66061.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/20a84ef97806ec90c892f95a709c8f89.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/c1e9289ab4c62b5453b0e2b19ba54ddc.png)

有时也会与一些预定义的error进行比较  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/03db121ed18d020313b88e7ef3695c55.png)

![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/d05948f47743d96dcee7d41152ec6195.png)

由于任何实现了error接口的类型均可以作为error来处理，所以往往也会使用类型断言来检查error:  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/b58b55b53d317447571daadcbd8861ba.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/b21ed364e20cb4dfc2b16afbba600f3a.png)

wrapError看起来很像os.PathError  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/97e1706dc920a801c124ca91a6697b99.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/44bf016c5e314f3384167167883b8b22.png)

找到`%`的位置  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/9aecdda0848ad376802c67a752a31454.png)

因为都不符合，所以走的是default 分支  
在对传入的入参进行类型处理  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/884c40bb6a9edf91ad4a50fe5e0fa257.png)

因为error是interface，所以会走这个逻辑  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/ea91f610a4a3d32595c1228557b303bc.png)

在handlerMethod的时候，会对%w的动词做处理  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/d590957b96b2216753c5880c552ecf49.png)
...
>  ![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/08c7720390c606b1439d87296262a4a4.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/46f1e558b3400c51f9697d64dbb81f65.png)
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/559b6a69cd05abe88a42615ed85dead4.png)

如果err没有实现Unwrap函数，则不是wrapError，直接返回nil，否则调用Unwrap函数并返回。  
对于自定义的error类型，在实现Error函数的基础上，需要额外实现Unwrap函数，可以升级成链式error。  
比如os.PathError  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/f075afc852fd53e4491615d5517607a6.png)
