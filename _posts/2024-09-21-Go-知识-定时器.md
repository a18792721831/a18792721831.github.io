...
#### Go-知识-定时器
  ...
  * [1\. 介绍](<#1__7>)
  * [2\. Timer使用场景](<#2_Timer_23>)
  *     * [2.1 设定超时时间](<#21__24>)
    * [2.2 延迟执行某个方法](<#22__42>)
  * [3\. Timer 对外接口](<#3_Timer__59>)
  *     * [3.1 创建定时器](<#31__60>)
    * [3.2 停止定时器](<#32__63>)
    * [3.3 重置定时器](<#33__72>)
    * [3.4 After](<#34_After_78>)
    * [3.5 AfterFunc](<#35_AfterFunc_93>)
  * [4\. Timer 的实现原理](<#4_Timer__111>)
  *     * [4.1 Timer数据结构](<#41_Timer_112>)
    *       * [4.1.1 Timer](<#411_Timer_113>)
      * [4.1.2 runtimeTimer](<#412_runtimeTimer_123>)
    * [4.2 Timer 实现原理](<#42_Timer__146>)
    *       * [4.2.1 创建Timer](<#421_Timer_149>)
      * [4.2.2 停止Timer](<#422_Timer_225>)
      * [4.2.3 重置Timer](<#423_Timer_241>)
  * [5\. Ticker 使用场景](<#5_Ticker__254>)
  *     * [5.1 简单定时任务](<#51__255>)
    * [5.2 定时刷新缓存](<#52__272>)
  * [6\. Ticker 对外接口](<#6_Ticker__303>)
  *     * [6.1 创建定时器](<#61__304>)
    * [6.2 停止定时器](<#62__332>)
    * [6.3 Tick](<#63_Tick_344>)
  * [7\. Ticker 实现原理](<#7_Ticker__370>)
  *     * [7.1 数据结构](<#71__373>)
    *       * [7.1.1 Ticker](<#711_Ticker_374>)
      * [7.1.2 runtimeTimer](<#712_runtimeTimer_384>)
    * [7.2 Ticker实现原理](<#72_Ticker_407>)
    *       * [7.2.1 创建Ticker](<#721_Ticker_408>)
      * [7.2.2 停止Ticker](<#722_Ticker_472>)
  * [8\. runtimeTimer 原理(go 1.11)](<#8_runtimeTimer_go_111_489>)
  *     * [8.1 定时器存储](<#81__496>)
    *       * [8.1.1 timer 的数据结构](<#811_timer__497>)
      * [8.1.2 timersBucket 的数据结构](<#812_timersBucket__519>)
      * [8.1.3 Ticker & timer & timersBucket 关系](<#813_Ticker__timer__timersBucket__544>)
      * [8.1.4 timersBucket 数组](<#814_timersBucket__549>)
    * [8.2 定时器运行机制](<#82__566>)
    *       * [8.2.1 创建定时器](<#821__567>)
      * [8.2.2 删除定时器](<#822__790>)
    * [8.3 资源泄露](<#83__830>)
  * [9\. 性能优化 (go 1.14+)](<#9__go_114_838>)
  *     * [9.1 消除了timersBucket](<#91_timersBucket_842>)
    * [9.2 消除了timeproc](<#92_timeproc_852>)
    * [9.3 更少的锁竞争](<#93__858>)
    * [9.4 更少的上下文切换](<#94__865>)
    * [9.5 优化效果](<#95__874>)
