...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/0a2e012d55f2addbfb4d591accf6dcaa.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/c3f586666e0710f8e584f87127056419.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/c7a543a93b1fb95aa03e06579a591306.png)  
...
项目结构如图  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/51cfdfdb39b6602b9e0ded3ea1a9ac4e.png)
...
创建UI  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/eb25c1be95a789e6112900fedfde2452.png)  
增加后，会生成java类和form文件  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/701eded8eb0e648914cdf06d461a731c.png)

界面结构如下，需要什么，可以拖动控件放到需要的位置上  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/cff879f541a02a61abbe1093480bda2f.png)  
最顶层是一个JPanel，属性名字是rootPanel  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/b877b5ef6aebaba3e4f0cfc6fcf26cac.png)  
为了方便管理，我们增加一个二级Pannel，不需要名字，增加边框  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/e6527a5b5d3f990e55d4fe7a39567980.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/699a9851e5aab1931811d003dad0316a.png)  
然后设置module的启动配置  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/9fbf8c441a423276895b9a33ee757388.png)  
有了启动配置后，进行编译，编译成功后，java类中就会自动生成代码  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/c3ed01a3b4d80afb6b73b19b2d701bb4.png)  
前面说过，我们需要获取输入框的控件，然后获取输入的值，设置动作监听等等，所以使用lombok将JTextField控件暴露出去  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/fa5ee14b14b4239fdcd21f463e3b7631.png)  
将lombok加入到classpath中(lombok在高版本的idea中自动支持)  
加入后会下载相关的jar，有可能会非常慢  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/10f7d0b8943f006bacdaf660cdbc6896.png)  
需要注意，rootJPanel也需要增加getter方法  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/e841366f0c825a17654ebe375ede7bbc.png)  
虽然自动生成了getRootComponent方法，但是这个方法不是给我们编码用的  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/39eb65e2091355af3491919a5ee5d4e8.png)  
注释的很明白，不要在你的代码中使用这些方法  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/c7061df4b69a6589bed394ad157f3f8b.png)

在java文件中，右键，自动生成测试方法  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/8ff10a9033058e520f76f62b553d2262.png)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/2305ca7a1881782bb454deb659ca98ec.png)  
一定要给最顶层的JPanel设置属性名字，才能自动生成测试方法  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/84c2209311c2613c119689a57796ee6d.png)  
你的UI就会展示出来  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/d21b9c3b64ab9bd120828c552664e827.png)  
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/847aa0212deda271d0f45af3e805d888.png)  
启动测试下(注意启动正确的module)  
首先是setting的配置页  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/b360a71c264ca7974331efca09b8ff0e.png)  
可以看到，这里配置的就是我们在`plugin.xml`中配置的数据生效了。  
接下来是配置界面  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/25bcac62d578b4323e28a25d27e0dc3f.png)  
也是一样的，我们试着配置  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/9a985350853a2a9f029500b12d1ed8f6.png)  
然后使用tools下的菜单触发  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/f057a922da89c8b960028b0c279f97cc.png)  
因为我们使用的是唯一的沙盒，所有会有helloword的插件。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/ffc48a20168b65632b9f3f96e55b4658.png)  
点击，发现和预期的一样，通知里面是我们配置的值。  
接下来重启idea(沙盒的)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/b79a7f4a8d1d76fb45a68c11a0df5b96.png)  
可以看到，重启沙盒的idea后，原本开发的idea的调试关联就丢失了  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/2e2f615acbf8a9e3f8e0250aae717404.png)  
在非调试的状态下，重新触发读取操作，发现还是能够读取到我们配置的值，即使我们重启过idea(沙盒)  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/b637d7842f6d86c7b0ee0cc518be4033.png)  
这样就达到了我们的目的。
...
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/43d56e0c6b6c009df8612bfc945f21e9.png)  
要实现这个小功能，也很简单，在获取配置的JPanel的之前，将配置中的值，设置到控件中即可。  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/0c7dd1f814b50336af2a3863012dbfb3.png)  
还记得吗，我们之前配置的值是“测试1”，现在打开配置界面，看看输入框中是不是  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/917ca2650359033d60cb8be1c8b77638.png)  
预期一致。

### 打包

打包后会生成可安装的压缩包  
![在这里插入图片描述](https://picgo-1302191088.cos.ap-guangzhou.myqcloud.com/csdn/csdnimg/702aec8abd853b108b824bc415959436.png)  
